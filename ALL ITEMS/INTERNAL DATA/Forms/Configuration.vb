...
Public Class Configuration
    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.Hint = "Delete" Then
            ...
            If Me.GridControl1.FocusedView.Name = "DepartmentsView" Then
                ...
                End If
            ElseIf Me.GridControl1.FocusedView.Name = "DepartmentsParameterView" Then
                If XtraMessagebox.Show("Should the Department Parameter: " & IdRowValue & " be deleted ? ", "DELETE DEPARTMENT PARAMETER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    If cmd.Connection.State = ConnectionState.Closed Then
                        cmd.Connection.Open()
                    End If
                    'Delete Parameter with the same [IdABTEILUNGSPARAMETER]
            ...
            ElseIf Me.GridControl1.FocusedView.Name = "ParameterView" Then
                ...
                If XtraMessagebox.Show("Should the Parameter: " & IdRowValue & vbNewLine & "with ID: " & IDNrRowValue & " be deleted?", "DELETE PARAMETER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
        ...
        If e.Button.Hint = "ExportToExcel" Then
            Try
                ...
                cmd.ExecuteNonQuery()
                cmd.CommandText = "INSERT INTO OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'EXCEL 12.0;Database=" & ExcelParameterFile & ";','SELECT * FROM [PARAMETER$]') select [PARAMETER1],[PARAMETER2],[PARAMETER STATUS],[PARAMETER INFO],[IdABTEILUNGSPARAMETER],[NPARAMETER1],[NPARAMETER2] from [PARAMETER]"
                cmd.ExecuteNonQuery()
                cmd.Connection.Close()
                SplashScreenManager.CloseForm(False)
        ...
        If e.Button.Hint = "ImportFromExcel" Then
            Try
                If XtraMessagebox.Show("Should the Application Parameters be imported from the specified Excel File ?" & vbNewLine & vbNewLine & "+++ ATTENTION: The current Parameters will be deleted!!! +++ ", "IMPORT PSTOOL PARAMETERS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    ...
                    cmd.ExecuteNonQuery()
                    cmd.CommandText = "IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='PARAMETER_Temp' AND xtype='U') CREATE TABLE [dbo].[PARAMETER_Temp]([ID] [int] IDENTITY(1,1) NOT NULL,[PARAMETER1] [nvarchar](255) NULL,[PARAMETER2] [nvarchar](255) NULL,[PARAMETER STATUS] [nvarchar](255) NULL,[PARAMETER INFO] [ntext] NULL,[IdABTEILUNGSPARAMETER] [nvarchar](255) NULL,[NPARAMETER1] [float] NULL,[NPARAMETER2] [float] NULL) ELSE DELETE FROM [ABTEILUNGSPARAMETER_Temp]"
                    cmd.ExecuteNonQuery()
                    ...
                    cmd.ExecuteNonQuery()
                    cmd.CommandText = "INSERT INTO [PARAMETER] ([PARAMETER1],[PARAMETER2],[PARAMETER STATUS],[PARAMETER INFO],[IdABTEILUNGSPARAMETER],[NPARAMETER1],[NPARAMETER2]) SELECT [PARAMETER1],[PARAMETER2],[PARAMETER STATUS],[PARAMETER INFO],[IdABTEILUNGSPARAMETER],[NPARAMETER1],[NPARAMETER2] FROM [PARAMETER_Temp]"
                    cmd.ExecuteNonQuery()
    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.Hint = "Delete Parameter" Then
            If XtraMessagebox.Show("Should the Parameter ID: " & ID_Nr_RowValue_All_Parameters & " be deleted?", "DELETE PARAMETER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
