...
Public Class Cash_Flows
    ...
    Private Sub Cash_Flows_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conn.ConnectionString = My.Settings.PS_TOOL_DX_SQL_Client_ConnectionString
        cmd.Connection = conn

        'Bind Combobox
        Me.FristenDateEdit.Properties.Items.Clear()
        Me.QueryText = "Select CONVERT(VARCHAR(10),[RiskDate],104) as 'RLDC Date' from [CASH_FLOWS_FINRECON]  GROUP BY [RiskDate] Order by [RiskDate] desc"
        ...
        Dim SqlMaxFristenDate As String = MaxFristenDate.ToString("yyyyMMdd")
        ...
        query.Sql = "Select * from [CASH_FLOWS_FINRECON] where RiskDate= '" & SqlMaxFristenDate & "'"
        ds.Queries.Add(query)
        ds.Fill()
        Me.GridControl2.DataSource = Nothing
        Me.GridControl2.DataSource = ds
        Me.GridControl2.DataMember = "customQuery1"
        Me.GridControl2.MainView = FristenBaseView
...
#End Region
    ...
    Private Sub FristenDateEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles FristenDateEdit.ButtonClick
        If e.Button.Caption = "Reload" Then
            ...
            If IsDate(Me.FristenDateEdit.Text) = True Then
                ...
                SplashScreenManager.Default.SetWaitFormCaption("Load Cash Flows for " & d)
                Dim connectionParameters As New CustomStringConnectionParameters(conn.ConnectionString)
                Dim ds As New SqlDataSource(connectionParameters)
                query.Name = "customQuery1"
                query.Sql = "Select * from [CASH_FLOWS_FINRECON] where RiskDate= '" & dsql & "'"
                ds.Queries.Add(query)
                ds.Fill()
                Me.GridControl2.DataSource = Nothing
                Me.GridControl2.DataSource = ds
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "Cash Flow Report " & "   " & "on: " & Me.FristenDateEdit.Text
