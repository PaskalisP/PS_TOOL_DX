    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If Me.GridControl2.FocusedView.Name = "ProductTypesBaseView" Then
                ...
                If XtraMessageBox.Show("Should the Product Type: " & ProductTypeValue & " be deleted?", "DELETE PRODUCT TYPE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
