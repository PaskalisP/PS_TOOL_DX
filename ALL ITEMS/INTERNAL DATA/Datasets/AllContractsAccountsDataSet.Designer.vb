    ...
    Partial Public Class ALL_CONTRACTS_ACCOUNTSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [ALL_CONTRACTS_ACCOUNTS] ([Contract_Account], [ClientNr], [ClientName"& _ 
                ...
                "nceDescription]) VALUES (@Contract_Account, @ClientNr, @ClientName, @ContractTyp"& _ 
                "e, @ProductType, @StartDate, @MaturityDate, @BusinessType, @KEV_Collateral, @Val"& _ 
                "id, @AnaCredit_Valid, @IsAnaCredit, @CCY, @GSTIFF_Reference, @CCB_Group, @InputD"& _ 
                "ate, @TypeOfInstrument, @TypeOfInstrumentDescription, @AmortisationType, @Amorti"& _ 
                "sationTypeDescription, @FiduciaryInstrument, @FiduciaryInstrumentDescription, @I"& _ 
                "nterestRate, @Spread, @InterestRateType, @InterestRateTypeDescription, @Interest"& _ 
                "RateCap, @InterestRateFloor, @InterestRateResetFrequency, @InterestRateResetFreq"& _ 
                "uencyDescription, @CommitmentAmountInceptionOrig, @ExchangeRate, @CommitmentAmou"& _ 
                "ntInceptionEUR, @PaymentFrequency, @PaymentFrequencyDescription, @ProjectFinance"& _ 
                "Loan, @ProjectFinanceLoanDescription, @Purpose, @PurposeDescription, @Recourse, "& _ 
                "@RecourseDescription, @ReferenceRate, @ReferenceRateDescription, @SettlementDate"& _ 
                ", @SyndicatedContractIdentifier, @RepaymentRights, @RepaymentRightsDescription, "& _ 
                "@InterestRateAverage, @NextInterestRateDateReset, @DefaultStatusInstrument, @Def"& _ 
                "aultStatusInstrumentDescription, @DateDefaultStatusInstrument, @AmountPastDue, @"& _ 
                "DatePastDue, @TypeOfSecurisation, @TypeOfSecurisationDescription, @OutstandingNo"& _ 
                "minalAmount, @AccountingClassifInstruments, @AccountingClassifInstrumentsDescrip"& _ 
                "tion, @PerformingStatusInstrument, @PerformingStatusInstrumentDescription, @Date"& _ 
                "PerformingStatus, @StatusForbearance, @DateStatusForbearance, @ComulativeRecover"& _ 
                "yAmount, @StatusForbearance_Description, @Contract_AccountM, @ClientNrM, @Contra"& _ 
                "ctTypeDescription, @ProductTypeDescription, @CounterpartyRole, @CounterpartyRole"& _ 
                "Description, @JointLiabilityAmount, @EndDateOfInterestPaymentOnlyPeriod, @WriteO"& _ 
                "ffsStatus, @ImpairmentStatus, @SourcesOfEncumbrance, @SourcesOfEncumbranceDescri"& _ 
                "ption)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [ALL_CONTRACTS_ACCOUNTS] SET [Contract_Account] = @Contract_Account, [Clie"& _ 
                ...
                "nce, [SourcesOfEncumbranceDescription] = @SourcesOfEncumbranceDescription WHERE "& _ 
                "(([ID] = @Original_ID))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, Contract_Account, ClientNr, ClientName, ContractType, ProductTy"& _ 
                ...
                "                        SourcesOfEncumbranceDescription"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ALL_CON"& _ 
                "TRACTS_ACCOUNTS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (ClientNr <> '0')"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY StartDate DESC"
            ...
            Me._commandCollection(1).CommandText = "SELECT AccountingClassifInstruments, AccountingClassifInstrumentsDescription, Amo"& _ 
                ...
                "rument, FiduciaryInstrumentDescription, GSTIFF_Reference, ID, ImpairmentStatus, "& _ 
                "InputDate, InterestRate, InterestRateAverage, InterestRateCap, InterestRateFloor"& _ 
                ", InterestRateResetFrequency, InterestRateResetFrequencyDescription, InterestRat"& _ 
                "eType, InterestRateTypeDescription, IsAnaCredit, JointLiabilityAmount, KEV_Colla"& _ 
                "teral, MaturityDate, NextInterestRateDateReset, OutstandingNominalAmount, Paymen"& _ 
                "tFrequency, PaymentFrequencyDescription, PerformingStatusInstrument, PerformingS"& _ 
                "tatusInstrumentDescription, ProductType, ProductTypeDescription, ProjectFinanceL"& _ 
                "oan, ProjectFinanceLoanDescription, Purpose, PurposeDescription, Recourse, Recou"& _ 
                "rseDescription, ReferenceRate, ReferenceRateDescription, RepaymentRights, Repaym"& _ 
                "entRightsDescription, SettlementDate, SourcesOfEncumbrance, SourcesOfEncumbrance"& _ 
                "Description, Spread, StartDate, StatusForbearance, StatusForbearance_Description"& _ 
                ", SyndicatedContractIdentifier, TypeOfInstrument, TypeOfInstrumentDescription, T"& _ 
                "ypeOfSecurisation, TypeOfSecurisationDescription, Valid, WriteOffsStatus FROM AL"& _ 
                "L_CONTRACTS_ACCOUNTS WHERE (Contract_Account = @Param1)"
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal ImpairmentStatus As String,  _
                    ByVal SourcesOfEncumbrance As String,  _
                    ByVal SourcesOfEncumbranceDescription As String) As Integer
