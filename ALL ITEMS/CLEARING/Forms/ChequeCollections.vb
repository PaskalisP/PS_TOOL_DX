    ...
    Private Sub Gridcontrol1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            If Me.ChequeCollections_Basic_GridView.SelectedRowsCount > 0 Then
                ...
                If MessageBox.Show("Should the Cheque Collection with Cheque Nr. " & chequeNo & " be deleted ?", "DELETE CHEQUE COLLECTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Try
