...
#Region "BUTTONS_AND_EDITORS_EVENTS"
    Private Sub LastBaisImportFile_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles LastBaisImportFile.ButtonClick
        If IsNumeric(LastBaisImportFile.Text) = True And Len(LastBaisImportFile.Text) = 8 Then
            If MessageBox.Show("Should the BAISForms File Nr. " & LastBaisImportFile.Text & " be saved as Last Imported BAIS file", "CHANGE THE LAST IMPORTED BAISForms FILE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BaisAutomatedImport_btn_Click(sender As Object, e As EventArgs) Handles BaisAutomatedImport_btn.Click
        ...
        If Me.LastBaisImportFile.Text <> "" Then
            If MessageBox.Show("Should the automated BAIS Fileimport be executed?", "AUTOMATED IMPORT BAIS FILES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BaisSelectedImport_btn_Click(sender As Object, e As EventArgs) Handles BaisSelectedImport_btn.Click
        ...
        BaisImportFromTill_btn_clicked = False
        If Me.SelectedBaisImportFile.Text <> "" Then
            If MessageBox.Show("Should the BAIS Filename " & SelectedBaisImportFile.Text & " be imported?", "IMPORT BAIS FILE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                DISABLE_START_IMPORT()
                If Me.BgwBAISimport.IsBusy = False Then
                    Me.BgwBAISimport.RunWorkerAsync()
                End If
    ...
    Private Sub BaisFromTillImport_btn_Click(sender As Object, e As EventArgs) Handles BaisFromTillImport_btn.Click
        ...
        If Me.BaisImportFileFrom.Text <> "" AndAlso Me.BaisImportFileTill.Text <> "" Then
            ...
            If n2 >= n1 Then
                If MessageBox.Show("Should the BAIS Import start with Filename " & n1 & " and finish with Filename " & n2, "IMPORT BAIS FILE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    DISABLE_START_IMPORT()
                    If Me.BgwBAISimport.IsBusy = False Then
