...
Public Class BaisExportAnaCreditV126
    ...
    Private Sub BaisExportAnaCreditV126_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAnaCreditV126_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_AnaCredit_v1.26_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_AnaCredit_v1.26_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
            ...
            Try
                ...
                If ParameterStatus = "Y" Then
                    ...
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        cmd.CommandText = SqlCommandText
                        If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                            BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACCPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                            cmd.ExecuteNonQuery()
                        End If
                    Next
                End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACFDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACFAIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACIPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
    ...
    Private Sub ACCFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACCFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACIFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACIFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPCIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACPCIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPDIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.26/ACPDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
