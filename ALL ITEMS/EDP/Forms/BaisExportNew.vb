...
Public Class BaisExportNew
    ...
    Private Sub BaisExportNew_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportNew_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub BgwBaisFilesCreation_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BgwBaisFilesCreation.RunWorkerCompleted
        ...
        End If
        If Me.KGCIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "KGCIFF File created with success - " & BaisFilesCreationPath & "KGCIFF_CCB.csv"
        End If
        If Me.KNEIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "KNEIFF File created with success - " & BaisFilesCreationPath & "KNEIFF_CCB.csv"
        End If
        If Me.KNVIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "KNVIFF File created with success - " & BaisFilesCreationPath & "KNVIFF_CCB.csv"
        End If
        If Me.KRKIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "KRKIFF File created with success - " & BaisFilesCreationPath & "KRKIFF_CCB.csv"
        End If
        If Me.KSRIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "KSRIFF File created with success - " & BaisFilesCreationPath & "KSRIFF_CCB.csv"
        End If
        If Me.LQGIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "LQGIFF File created with success - " & BaisFilesCreationPath & "LQGIFF_CCB.csv"
        End If
        If Me.MKUIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "MKUIFF File created with success - " & BaisFilesCreationPath & "MKUIFF_CCB.csv"
        End If
        If Me.ZUSIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "ZUSIFF File created with success - " & BaisFilesCreationPath & "ZUSIFF_CCB.csv"
        End If
        If Me.GAKIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "GAKIFF File created with success - " & BaisFilesCreationPath & "GAKIFF_CCB.csv"
        End If
        If Me.GAGIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "GAGIFF File created with success - " & BaisFilesCreationPath & "GAGIFF_CCB.csv"
        End If
        If Me.LQKIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "LQKIFF File created with success - " & BaisFilesCreationPath & "LQKIFF_CCB.csv"
        End If
        If Me.DESIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "DESIFF File created with success - " & BaisFilesCreationPath & "DESIFF_CCB.csv"
        End If
        If Me.WHGIFF_Result_lbl.Text <> "" Then
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "WHGIFF File created with success - " & BaisFilesCreationPath & "WHGIFF_CCB.csv"
        End If
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_v1.21_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_v1.21_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
    ...
    Private Sub DVTIFF_CREATION()
        ...
        If Count = 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "DVTIFF_MDANT|DVTIFF_GSREF|DVTIFF_FILNR|DVTIFF_KDNRH|DVTIFF_DXABD|DVTIFF_GSKLA|DVTIFF_SUKLA|DVTIFF_DVART|DVTIFF_DXVAL|DVTIFF_DANWC|DVTIFF_DANBT|DVTIFF_DVKWC|DVTIFF_DVKBT|DVTIFF_HBKZN|DVTIFF_ZWRIS|DVTIFF_KBTRG|DVTIFF_PTEIN|DVTIFF_WHGKP|DVTIFF_BCHSW|DVTIFF_WHGBU|DVTIFF_URDEA|DVTIFF_NETKR|DVTIFF_KZCVA|DVTIFF_GSARE|DVTIFF_FAIRV|DVTIFF_DXVKT|DVTIFF_HFZGP|DVTIFF_AFREF|DVTIFF_POOLI|DVTIFF_AEIDF|DVTIFF_BESVB|DVTIFF_RESE1|DVTIFF_RESE2|DVTIFF_FREI1|DVTIFF_FREI2|DVTIFF_FREI3|DVTIFF_LOEKZ|DVTIFF_IFNAM|DVTIFF_DXIFD"
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = DVTIFF_MDANT & DVTIFF_GSREF & DVTIFF_FILNR & DVTIFF_KDNRH & DVTIFF_DXABD & DVTIFF_GSKLA & DVTIFF_SUKLA & DVTIFF_DVART & DVTIFF_DXVAL & DVTIFF_DANWC & DVTIFF_DANBT & DVTIFF_DVKWC & DVTIFF_DVKBT & DVTIFF_HBKZN & DVTIFF_ZWRIS & DVTIFF_KBTRG & DVTIFF_PTEIN & DVTIFF_WHGKP & DVTIFF_BCHSW & DVTIFF_WHGBU & DVTIFF_URDEA & DVTIFF_NETKR & DVTIFF_KZCVA & DVTIFF_GSARE & DVTIFF_FAIRV & DVTIFF_DXVKT & DVTIFF_HFZGP & DVTIFF_AFREF & DVTIFF_POOLI & DVTIFF_AEIDF & DVTIFF_BESVB & DVTIFF_RESE1 & DVTIFF_RESE2 & DVTIFF_FREI1 & DVTIFF_FREI2 & DVTIFF_FREI3 & DVTIFF_LOEKZ & DVTIFF_IFNAM & DVTIFF_DXIFD
    ...
    Private Sub GSTSLF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "GSTSLF_MDANT|GSTSLF_MODUL|GSTSLF_KDNRH|GSTSLF_KTONR|GSTSLF_GSREF|GSTSLF_SLDUB|GSTSLF_DISPO|GSTSLF_DXDVD|GSTSLF_DXDBD|GSTSLF_ABGBT|GSTSLF_GKBTR|GSTSLF_FAIRV|GSTSLF_ERFBT|GSTSLF_IFNAM|GSTSLF_DXIFD"
                Dim CSV_ROW As String = Nothing
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = GSTSLF_MDANT & GSTSLF_MODUL & GSTSLF_KDNRH & GSTSLF_KTONR & GSTSLF_GSREF & GSTSLF_SLDUB & GSTSLF_DISPO & GSTSLF_DXDVD & GSTSLF_DXDBD & GSTSLF_ABGBT & GSTSLF_GKBTR & GSTSLF_FAIRV & GSTSLF_ERFBT & GSTSLF_IFNAM & GSTSLF_DXIFD
    ...
    Private Sub KGCIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File KGCIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_KGCIFF for this Date" & vbNewLine & " Please import the related KGCIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub KNEIFF_CREATION()
        ...
        cmd.ExecuteNonQuery()
        BgwBaisFilesCreation.ReportProgress(1, "Set Field:[KNEIFF_GRPKZ]=S only if Customer Code in Table:CUSTOMER_INFO with Field:CCB_Group='Y'")
        cmd.CommandText = "UPDATE [BAIS_KNEIFF] SET [KNEIFF_GRPKZ]='S' where [KNEIFF_DXIFD]='" & rdsql & "' and  [KNEIFF_KDNRH] in (Select ClientNo from CUSTOMER_INFO where CCB_Group='Y')"
        cmd.ExecuteNonQuery()
        ...
        If Count <> 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "KNEIFF_MDANT|KNEIFF_FILNR|KNEIFF_KDNRH|KNEIFF_KURZN|KNEIFF_NAME1|KNEIFF_NAME2|KNEIFF_NAME3|KNEIFF_PLZOR|KNEIFF_PLZNR|KNEIFF_STRAS|KNEIFF_DXGEB|KNEIFF_WSGSI|KNEIFF_BRNCH|KNEIFF_WSBIS|KNEIFF_BRNZU|KNEIFF_SLDSL|KNEIFF_RLDSL|KNEIFF_LDRIS|KNEIFF_BONIT|KNEIFF_GRPKZ|KNEIFF_KZLST|KNEIFF_KZPER|KNEIFF_UMMIO|KNEIFF_AUSFL|KNEIFF_DXAUD|KNEIFF_ORGSL|KNEIFF_RISGR|KNEIFF_KGBID|KNEIFF_ANRKZ|KNEIFF_ESAKZ|KNEIF_ESAK2|KNEIF_ESAK3|KNEIF_KUKON|KNEIFF_NACES|KNEIFF_LENID|KNEIFF_WSCRR|KNEIF_WSFIN|KNEIFF_AVCKZ|KNEIF_RECHF|KNEIF_KNBOG|KNEIF_MITAR|KNEIFF_FREI1|KNEIFF_FREI2|KNEIFF_FREI3|KNEIFF_FREI4|KNEIFF_FREI5|KNEIFF_LOEKZ|KNEIFF_IFNAM|KNEIFF_DXIFD"
                Dim CSV_ROW As String = Nothing
                ...
                Dim KNEIF_ESAK2 As String = Nothing 'New
                Dim KNEIF_ESAK3 As String = Nothing 'New
                Dim KNEIF_KUKON As String = Nothing 'New
                Dim KNEIFF_NACES As String = Nothing
                Dim KNEIFF_LENID As String = Nothing
                Dim KNEIFF_WSCRR As String = Nothing
                Dim KNEIF_WSFIN As String = Nothing 'New
                Dim KNEIFF_AVCKZ As String = Nothing
                Dim KNEIF_RECHF As String = Nothing 'New
                Dim KNEIF_KNBOG As String = Nothing 'New
                Dim KNEIF_MITAR As String = Nothing 'New
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    KNEIFF_UMMIO = dt.Rows.Item(i).Item("KNEIFF_UMMIO") & "|"
                    ...
                    KNEIF_ESAK2 = dt.Rows.Item(i).Item("KNEIF_ESAK2") & "|" 'New
                    KNEIF_ESAK3 = dt.Rows.Item(i).Item("KNEIF_ESAK3") & "|" 'New
                    KNEIF_KUKON = dt.Rows.Item(i).Item("KNEIF_KUKON") & "|" 'New
                    ...
                    KNEIF_WSFIN = dt.Rows.Item(i).Item("KNEIF_WSFIN") & "|" 'New
                    KNEIFF_AVCKZ = dt.Rows.Item(i).Item("KNEIFF_AVCKZ") & "|"
                    KNEIF_RECHF = dt.Rows.Item(i).Item("KNEIF_RECHF") & "|" 'New
                    KNEIF_KNBOG = dt.Rows.Item(i).Item("KNEIF_KNBOG") & "|" 'New
                    KNEIF_MITAR = dt.Rows.Item(i).Item("KNEIF_MITAR") & "|" 'New
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File KNEIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_KNEIFF for this Date" & vbNewLine & " Please import the related KNEIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub KNVIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File KNVIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_KNVIFF for this Date" & vbNewLine & " Please import the related KNVIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub KRKIFF_CREATION()
        ...
        cmd.ExecuteNonQuery()
        cmd.CommandText = "INSERT INTO [BAIS_KRKIFF]([KRKIFF_KDNRH],[KRKIFF_RKLIF],[KRKIFF_DXIFD]) Select  [ClientNo],[ClientNo],'" & rdsql & "' FROM [CUSTOMER_RATING] where [ExternalRating] not in ('No Rating')"
        cmd.ExecuteNonQuery()
    ...
    Private Sub KSRIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                cmd.ExecuteNonQuery()
                cmd.CommandText = "INSERT INTO [BAIS_KSRIFF]([KSRIFF_RKLIF],[KSRIFF_RATEX],[KSRIFF_DXRAT],[KSRIFF_DXIFD]) Select  [ClientNo],[ExternalRating],'" & rdsql & "','" & rdsql & "' FROM [CUSTOMER_RATING] where [ExternalRating] not in ('No Rating')"
                cmd.ExecuteNonQuery()
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File KSRIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_KSRIFF for this Date" & vbNewLine & " Please import the related KSRIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub LQGIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File LQGIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_LQGIFF for this Date" & vbNewLine & " Please import the related LQGIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub MKUIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "MKUIFF_MDANT|MKUIFF_WPKNR|MKUIFF_HAWHG|MKUIFF_PREIS|MKUIFF_PREI2|MKUIFF_STRKU|MKUIFF_BEWAB|MKUIFF_BWALA|MKUIFF_POOLF|MKUIFF_FREI1|MKUIFF_CLEAN|MKUIFF_IFNAM|MKUIFF_DXIFD"
                Dim CSV_ROW As String = Nothing
                ...
                Dim MKUIFF_CLEAN As String = Nothing
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    MKUIFF_WPKNR = dt.Rows.Item(i).Item("MKUIFF_WPKNR") & "|"
                    ...
                    MKUIFF_CLEAN = dt.Rows.Item(i).Item("MKUIFF_CLEAN") & "|"
                    MKUIFF_IFNAM = dt.Rows.Item(i).Item("MKUIFF_IFNAM") & "|"
                    MKUIFF_DXIFD = String.Format("{0:yyyyMMdd}", dt.Rows.Item(i).Item("MKUIFF_DXIFD"))


                    CSV_ROW = MKUIFF_MDANT & MKUIFF_WPKNR & MKUIFF_HAWHG & MKUIFF_PREIS & MKUIFF_PREI2 & MKUIFF_STRKU & MKUIFF_BEWAB & MKUIFF_BWALA & MKUIFF_POOLF & MKUIFF_FREI1 & MKUIFF_CLEAN & MKUIFF_IFNAM & MKUIFF_DXIFD
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File MKUIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_MKUIFF for this Date" & vbNewLine & " Please import the related MKUIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub ZUSIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File ZUSIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_ZUSIFF for this Date" & vbNewLine & " Please import the related ZUSIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub GAKIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File GAKIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_GAKIFF for this Date" & vbNewLine & " Please import the related GAKIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub GAGIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "GAGIFF_MDANT|GAGIFF_GARFN|GAGIFF_MODUL|GAGIFF_KDNRH|GAGIFF_GKRKT|GAGIFF_GSREF|GAGIFF_GLFDN|GAGIFF_HCKRA|GAGIFF_KZSUB|GAGIFF_KZZWB|GAGIFF_FREI1|GAGIFF_FREI2|GAGIFF_FREI3|GAGIFF_LOEKZ|GAGIFF_IFNAM|GAGIFF_DXIFD"
                Dim CSV_ROW As String = Nothing
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = GAGIFF_MDANT & GAGIFF_GARFN & GAGIFF_MODUL & GAGIFF_KDNRH & GAGIFF_GKRKT & GAGIFF_GSREF & GAGIFF_GLFDN & GAGIFF_HCKRA & GAGIFF_KZSUB & GAGIFF_KZZWB & GAGIFF_FREI1 & GAGIFF_FREI2 & GAGIFF_FREI3 & GAGIFF_LOEKZ & GAGIFF_IFNAM & GAGIFF_DXIFD
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File GAGIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_GAGIFF for this Date" & vbNewLine & " Please import the related GAGIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub LQKIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            End Try
        Else
            MessageBox.Show("Unable to create File LQKIFF_CCB.csv for " & rd & vbNewLine & "There are no data in Table BAIS_LQKIFF for this Date" & vbNewLine & " Please import the related LQKIFF_CCB.csv file for the requested Date!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub DESIFF_CREATION()
        ...
        Else
            If cmd.Connection.State = ConnectionState.Open Then
                cmd.Connection.Close()
            End If
            MessageBox.Show("Unable to create File DESIFF_CCB.csv for " & rd & vbNewLine & "There are no Data in the Table:CREDIT RISK for this Date" & vbNewLine & " Please update CREDIT RISK Table", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
    ...
    Private Sub WHGIFF_CREATION()
        ...
        Else
            If cmd.Connection.State = ConnectionState.Open Then
                cmd.Connection.Close()
            End If
            MessageBox.Show("Unable to create File WHGIFF_CCB.csv for " & rd & vbNewLine & "There are no Data in the Table:EXCHANGE RATES OCBS for this Date" & vbNewLine & " Please update EXCHANGE RATES OCBS Table", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
