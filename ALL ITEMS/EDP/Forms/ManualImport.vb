    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If MessageBox.Show("Should the manual Import Procedure: " & ProcName & " be deleted?", "DELETE MANUAL IMPORT PROCEDURE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    'Get Max Date
...
#End Region
    ...
    Private Sub StartImportButtonEdit_Click(sender As Object, e As EventArgs) Handles StartImportButtonEdit.Click
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BIC DIRECTORY" And BicFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new BIC DIRECTORY be imported?", "IMPORT BIC DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "SEPA DIRECTORY" And SepaFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new SEPA DIRECTORY be imported?", "IMPORT SEPA DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "SEPA FULL DIRECTORY" And SepaFullFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new SEPA FULL DIRECTORY be imported?", "IMPORT SEPA FULL DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BLZ DIRECTORY" And BlzFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new BLZ DIRECTORY be imported?", "IMPORT BLZ DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "CUSTOMER INFO" And CustInfoFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new CUSTOMER INFO Data be imported?", "IMPORT CUSTOMER INFO", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "CUSTOMER ACC INFO" And CustAccInfoFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new CUSTOMER ACCOUNT INFO Data be imported?", "IMPORT CUSTOMER ACC INFO", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "ODAS REMMITANCE" And OdasRemmitanceFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the ODAS Remmitance Payment File be imported?", "IMPORT ODAS REMMITANCE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "GMPS PAYMENTS" And GMPSFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the GMPS Payment File(s) be imported?", "IMPORT GMPS PAYMENTS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "ECB DAILY RATES" And ECB_RATES_FileDirectoryImport <> "" Then
            If MessageBox.Show("Should the today's ECB RATES be imported?", "IMPORT ECB RATES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "MULTIBANK KONVERTER KONTOINHABER" And MULTIBANK_KONVERTER_Kontoinhaber_FileDirectoryImport <> "" Then
            If MessageBox.Show("Should the MULTIBANK KONVERTER KONTOINHABER File be imported?", "IMPORT MULTIBANK KONVERTER KONTOINHABER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "TARGET2 DIRECTORY" And T2FileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new TARGET2 DIRECTORY be imported?", "IMPORT TARGET2 DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "ODAS FX DEALS" And FXFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the ODAS FX DEALS be imported?", "IMPORT ODAS FX DEALS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BIC PLUS DIRECTORY" And BicPlusFileDirectoryImport <> "" Then
            If MessageBox.Show("Should the new BIC PLUS DIRECTORY be imported?", "IMPORT BIC PLUS DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "IBAN PLUS DIRECTORY" And IbanPlusFullDirectoryImport <> "" Then
            If MessageBox.Show("Should the new IBAN PLUS DIRECTORY be imported?", "IMPORT IBAN PLUS DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "IBAN STRUCTURE DIRECTORY" And IbanStructureFullDirectoryImport <> "" Then
            If MessageBox.Show("Should the new IBAN STRUCTURE DIRECTORY be imported?", "IMPORT IBAN STRUCTURE DIRECTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "HOLIDAYS" And HolidaysDataImport <> "" Then
            If MessageBox.Show("Should the new HOLIDAYS File be imported?", "IMPORT HOLIDAYS DATA", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "OWN FX DEALS" And OwnFxDealsUpdate <> "" Then
            If MessageBox.Show("Should our own FX Deals for the Liquidity Management be updated in Table FX DAILY REVALUATION ?", "UPDATE OWN FX DEALS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BAIS FILES" And BaisFilesImport <> "" Then
            If MessageBox.Show("Should the BAIS Files be imported?", "IMPORT BAIS Files", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                BaisFilesImport = Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colFileDirImport)
                dir_BaisFiles.Clear()
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "CUSTOMER UPDATE OPICS" And OpicsCustUpdateFilesImport <> "" Then
            If MessageBox.Show("Should the related OPICS Files be imported in order to update the Tables" & vbNewLine & "CUSTOMER_INFO and the FX DAILY REVALUATION with OWN DEALS?", "IMPORT OPICS CUSTOMER Files", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                OpicsCustUpdateFilesImport = Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colFileDirImport)
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "OPICS MM-FX DEALS" And OpicsMMDealsImport <> "" Then
            If MessageBox.Show("Should the OPICS MM and FX Deals be imported?", "IMPORT OPICS MM+FX DEALS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "DAILY BALANCE SHEET" And DailyBalanceSheetImport <> "" Then
            If MessageBox.Show("Should the DAILY BALANCE SHEET be imported?", "IMPORT DAILY BALANCE SHEET", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "DAILY BALANCE SHEET DETAILS" And DailyBalanceSheetDetailImport <> "" Then
            If MessageBox.Show("Should the DAILY BALANCE SHEET DETAILS be imported?", "IMPORT DAILY BALANCE SHEET DETAILS ", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "TRIAL BALANCE AVERAGE 222" And TrialBalanceAverage222Import <> "" Then
            If MessageBox.Show("Should the TRIAL BALANCE AVERAGE 222 Report be imported?", "TRIAL BALANCE AVERAGE 222 Report ", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "ACCRUED INTEREST ANALYSIS" And AccruedInterestAnalysisImport <> "" Then
            If MessageBox.Show("Should the ACCRUED INTEREST ANALYSIS Report be imported?", "ACCRUED INTEREST ANALYSIS Report ", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "USER PERMISSIONS IMPORT" And UserPermissionsImport <> "" Then
            If MessageBox.Show("Should the USER PERMISSIONS Reports be imported?", "USER PERMISSIONS IMPORT", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "NEW INVENTORY" And InventarExcelImport <> "" Then
            If MessageBox.Show("Should new Inventory from Excel File be imported?", "IMPORT NEW INVENTORY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "MIFIR IMPORT" And MifirImport <> "" Then
            If MessageBox.Show("Should the new MIFIR File be imported?", "IMPORT MIFIR", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Me.MANUAL_IMPORTSBindingSource.EndEdit()
                Me.MANUAL_IMPORTSTableAdapter.Update(Me.EDPDataSet.MANUAL_IMPORTS)
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                Me.ManualImportProcedures_BasicView.OptionsBehavior.ReadOnly = True
    ...
    Private Sub SelectFileButtonEdit_Click(sender As Object, e As EventArgs) Handles SelectFileButtonEdit.Click
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BIC DIRECTORY" Then
            With OpenFileDialog1
                BicFileDirectoryImport = Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colFileDirImport)
                .Filter = "DAT Files (*.dat;*.DAT)|*.dat;*.DAT"
                .DefaultExt = "DAT"
                .FilterIndex = 1
        ...
        If Me.ManualImportProcedures_BasicView.GetFocusedRowCellValue(colProcName) = "BIC PLUS DIRECTORY" Then
            With OpenFileDialog1
                ...
                .FileName = ""
                .Title = "Import BIC PLUS DIRECTORY File"
                .RestoreDirectory = True
                .Multiselect = False
    ...
    Private Sub BgwBicDirectory_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwBicDirectory.DoWork
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                da.Fill(dt)
                For i1 = 0 To dt.Rows.Count - 1
                    SqlCommandText1 = dt.Rows.Item(i1).Item("SQL_Command_1").ToString.Replace("<BIC_DIRECTORY_NEW_TXT_FILE>", BIC_DIRECTORY_NEW_TXT_FILE)
                    cmd.CommandText = SqlCommandText1
                    If dt.Rows.Item(i1).Item("SQL_Name_1") <> "" Then
                        SplashScreenManager.Default.SetWaitFormCaption(dt.Rows.Item(i1).Item("SQL_Name_1"))
    ...
    Private Sub BgwCustAccInfoDirectory_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwCustAccInfoDirectory.DoWork
        Try
            If File.Exists(CUST_ACC_INFO_DIR_FILE) = True Then
                ...
                'If MessageBox.Show("Should the table EAEG_KUNDEN_KONTEN be updated with new Data?" & vbNewLine & vbNewLine & "This procedure will take a few minutes!", "UPDATE EAEG KUNDEN KONTEN", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                'EAEG DATEN
                'Import GiroKonten
                ...
                For i = 0 To dir.Count - 1
                    ...
                    If File.Exists(GMPS_PAY_FILE) = True Then
                        ...
                        ElseIf xlWorksheet1.Range("A1").Value.ToString.StartsWith("Outward Remittance Report") = True Then
                            ...
                            xlWorksheet1.Range("AB1").Value = "RemittanceInformation"
                            xlWorksheet1.Range("AC1").Value = "SenderToReceiverInformation"
                            xlWorksheet1.Range("AD1").Value = "PayStartTime"
                            xlWorksheet1.Range("AE1").Value = "DebitTransactionsSigns"
                            xlWorksheet1.Range("AF1").Value = "ProcessingQueue"

                            xlWorksheet1.Range("AH1").Value = "ACK_State"
                            xlWorksheet1.Range("AI1").Value = "ProcessedBy"
...
#Region "IMPORT BIC PLUS DIRECTORY"
    Private Sub BgwBicPlusDirectory_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwBicPlusDirectory.DoWork
        Try
            If File.Exists(BIC_PLUS_DIR_FILE) = True Then
                ...
                cmd.CommandText = "SELECT [Status] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('IMPORT_BIC_DIRECTORY_PLUS') and [Id_SQL_Parameters] in ('MANUAL_IMPORTS')"
                Dim ParameterStatus As String = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND]  where [Id_SQL_Parameters_Details] in (Select [ID] from SQL_PARAMETER_DETAILS where SQL_Name_1 in ('IMPORT_BIC_DIRECTORY_PLUS')) and [SQL_Command_1] is not NULL  and [Status] in ('Y') order by [SQL_Float_1] asc"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i1 = 0 To dt.Rows.Count - 1
                ...
                Else
                    SplashScreenManager.CloseForm(False)
                    Me.BgwBicPlusDirectory.ReportProgress(30, "Unable to execute Import Procedure:IMPORT_BIC_DIRECTORY_PLUS! Parameter Status is Invalid!!")
                    MessageBox.Show("Unable to execute Import Procedure:IMPORT_BIC_DIRECTORY_PLUS! Parameter Status is Invalid!!", "BIC PLUS DIRECTORY IMPORT FAILLED", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
                    Return
                ...
                Me.BgwBicPlusDirectory.ReportProgress(100, "BIC DIRECTORY PLUS IMPORT FINISHED")
                SplashScreenManager.CloseForm(False)
            End If
        Catch ex As Exception
            If cmd.Connection.State = ConnectionState.Open Then
    ...
    Private Sub BgwBicPlusDirectory_ProgressChanged(sender As Object, e As ProgressChangedEventArgs) Handles BgwBicPlusDirectory.ProgressChanged
        cmdEVENT.Connection.Open()
        Try
            cmdEVENT.CommandText = "INSERT INTO [IMPORT EVENTS] ([EVENT],[ProcName],[SystemName]) Values('" & e.UserState & "','BIC DIRECTORY PLUS IMPORT','MANUAL IMPORTS')"
            cmdEVENT.ExecuteNonQuery()
            TextImportFileRow = Now & "  " & "BIC DIRECTORY PLUS IMPORT" & "  " & e.UserState & "  " & "MANUAL IMPORTS"
            System.IO.File.AppendAllText(ImportEventsDirectory, TextImportFileRow & vbCrLf)
        Catch ex As System.Exception
            cmdEVENT.CommandText = "INSERT INTO [IMPORT EVENTS] ([EVENT],[ProcName],[SystemName]) Values('ERROR +++ " & ex.Message.ToString.Replace("'", " ") & "','BIC DIRECTORY PLUS IMPORT','MANUAL IMPORTS')"
            cmdEVENT.ExecuteNonQuery()
            TextImportFileRow = Now & "  " & "BIC DIRECTORY PLUS IMPORT" & "  " & e.UserState & "  " & "MANUAL IMPORTS"
            System.IO.File.AppendAllText(ImportEventsDirectory, TextImportFileRow & vbCrLf)
            Exit Try
