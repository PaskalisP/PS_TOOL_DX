...
Public Class AWV
    ...
    Private Sub AWV_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        If Me.MeldewesenDataSet.HasChanges = True Then
            If MessageBox.Show("There some unsaved changes in this Form" & vbNewLine & "After closing the Form all changes will be lost!" & vbNewLine & "Exit anyway?", "UNSAVED CHANGES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.No Then
                e.Cancel = True
            Else
                e.Cancel = False
            End If
    ...
    Private Sub AWV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'MeldewesenDataSet.COUNTRIES' table. You can move, or remove it, as needed.
    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If MessageBox.Show("Should the Security with ISIN Code: " & ISIN & "  be deleted?", "DELETE POSTEN + WERTPAPIER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            Dim ID As String = row(0)
            If MessageBox.Show("Should the DIKAPOSTEN: " & ZAHLUNGSZWECK & "  be deleted?", "DELETE POSTEN + WERTPAPIER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub GridControl6_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            Dim ID As String = row(0)
            If MessageBox.Show("Should the TRANSITPOSTEN: " & WARENBEZEICHNUNG & "  be deleted?", "DELETE TRANSITPOSTEN", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub GridControl7_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            Dim BEZEICHNUNG As String = row(4)
            Dim ID As String = row(0)
            If MessageBox.Show("Should the DIRINVPOSTEN: " & BEZEICHNUNG & "  be deleted?", "DELETE DIRINPOSTEN", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub GridControl8_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            Dim BEZEICHNUNG As String = row(4)
            Dim ID As String = row(0)
            If MessageBox.Show("Should the ID Nr: " & ID & "  be deleted?", "DELETE AWVz11 Posten", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub LoadCreditRiskMak_btn_Click(sender As Object, e As EventArgs) Handles LoadCreditRiskMak_btn.Click
        If Me.ReportLocked_CheckEdit.CheckState = CheckState.Unchecked Then
            ...
            Else
                ...
                If MessageBox.Show("Should the XML File for the AWV Report " & RM & " be created?", "XML AVW FILE CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Try
                        ...
                        & XMLSAVEFILE & vbNewLine & vbNewLine & "Soll das Verzeichnis geöfnet werden?", "AWV XML Datei erfolgreich generiert", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
