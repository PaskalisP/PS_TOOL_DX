...
Public Class LiqV_Calc
    ...
    Private Sub SQL_Run_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_Run_BarButtonItem.ItemClick
        Try
            ...
            If MessageBox.Show("Should the stored procedure:LiqV_CALCULATION for " & rd & " be executed again?", "SQL COMMANDS  EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
