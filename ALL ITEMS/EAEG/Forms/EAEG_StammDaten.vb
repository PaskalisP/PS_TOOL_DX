...
Public Class EAEG_StammDaten
    ...
    Private Sub RepositoryItemImageComboBox1_EditValueChanged(sender As Object, e As EventArgs) Handles RepositoryItemImageComboBox1.EditValueChanged
        If XtraMessageBox.Show("Soll die Anrede des Kunden geändert werden?", "Neue Anrede", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
            Try
    ...
    Private Sub EAEG_StammDaten_BaseView_PrintInitialize(sender As Object, e As PrintInitializeEventArgs) Handles EAEG_StammDaten_BaseView.PrintInitialize
        If MessageBox.Show("Sollen die Kundenkonten details auch angezeigt werden?", "KONTEN DETAILS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
