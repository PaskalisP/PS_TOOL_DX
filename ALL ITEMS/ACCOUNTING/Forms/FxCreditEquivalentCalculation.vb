...
Public Class FxCreditEquivalentCalculation
    ...
    Private Sub FX_CredEquiv_Calculate_btn_Click(sender As Object, e As EventArgs) Handles FX_CredEquiv_Calculate_btn.Click
        If IsDate(Me.FxDateEdit.Text) = True Then
            ...
            If MessageBox.Show("Should FX Credit Equivalent Calculation with data from " & d & " be calculated?", "CALCULATION FX CREDIT EQUIVALENT", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
                    SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
