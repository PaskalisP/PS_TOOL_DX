...
Public Class JustizRegisterID_DE
    ...
    Private Sub JustizRegisterID_DE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "JUSTIZ ID (Amtsgericht) - Germany" & "  " & "Printed on: " & Now
        e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    End Sub

    Private Sub JustizID_GridView_RowStyle(sender As Object, e As RowStyleEventArgs) Handles JustizID_GridView.RowStyle
        If e.RowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            e.Appearance.BackColor = SystemColors.InactiveCaptionText
        End If
    End Sub

    Private Sub JustizID_GridView_ShownEditor(sender As Object, e As EventArgs) Handles JustizID_GridView.ShownEditor
