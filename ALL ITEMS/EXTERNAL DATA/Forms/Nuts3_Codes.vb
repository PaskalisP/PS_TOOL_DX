...
Public Class Nuts3_Codes
    ...
    Private Sub Nuts3_Codes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PLZ_Print_Export_btn_Click(sender As Object, e As EventArgs) Handles PLZ_Print_Export_btn.Click
        If XtraMessageBox.Show("The NUTS 3 Codes are over 2.1 Mio Datarows! Should the export be proceeded?", "LARGE DATA IN TABLE: NUTS_3", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = vbYes Then
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "NUTS 3 CODES" & "  " & "Printed on: " & Now
        e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    End Sub

    Private Sub NUTS3_GridView_RowStyle(sender As Object, e As RowStyleEventArgs) Handles NUTS3_GridView.RowStyle
        If e.RowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            e.Appearance.BackColor = SystemColors.InactiveCaptionText
        End If
    End Sub

    Private Sub NUTS3_GridView_ShownEditor(sender As Object, e As EventArgs) Handles NUTS3_GridView.ShownEditor
