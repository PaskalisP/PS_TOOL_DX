    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If Me.GridControl2.FocusedView.Name = "CurrenciesBaseView" Then
                ...
                If XtraMessageBox.Show("Should the Currency Code: " & CurrencyCode & " be deleted?", "DELETE CURRENCY CODE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
