...
e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    ...
    Private Sub MatchSwiftMessage_btn_Click(sender As Object, e As EventArgs) Handles MatchSwiftMessage_btn.Click
        If Me.OurReferenceSearch_GridLookUpEdit.Text <> "" Then
            If MessageBox.Show("Should the current Swift Message be matched with Export LC Reference " & Me.OurReferenceSearch_GridLookUpEdit.Text & " ? ", "MATCHING SWIFT MESSAGE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
                    cmd.Connection.Open()
