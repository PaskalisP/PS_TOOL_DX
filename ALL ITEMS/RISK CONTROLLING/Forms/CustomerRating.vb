...
Public Class CustomerRating
    ...
    Private Sub DeleteRatingDetails_btn_Click(sender As Object, e As EventArgs) Handles DeleteRatingDetails_btn.Click
        Try
            If MessageBox.Show("Should the current Rating be deleted?", "RATING DELETION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                If cmd.Connection.State = ConnectionState.Closed Then
                    cmd.Connection.Open()
                End If
