...
e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    ...
    Private Sub RecalculateUL_btn_Click(sender As Object, e As EventArgs) Handles RecalculateUL_btn.Click
        Try
            If IsDate(Me.UnexpectedLossDateEdit.Text) = True Then
                If MessageBox.Show("Should the Unexpected Loss and Granularity Approach be recalculated based on the Level of confidence for current Day?" & vbNewLine & vbNewLine & "Please note that this recalculation will NOT affect the Unexpected loss Amount in RISK LIMIT DAILY CONTROL!!!" & vbNewLine & vbNewLine & "You wish to proceed with the recalculation?", "UNEXPECTED LOSS - GRANULARITY APPROACH RECALCULATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BgwExcelLoad_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwExcelLoad.DoWork
        ...
        If dt1.Rows.Count > 0 Then
            ...
            Dim RangeDETAILS_W As Range = worksheet1.Range("W3:W" & DETAILS_LastRow)
            RangeDETAILS_W.Formula = "=P3*R3*V3"
            Dim RangeDETAILS_X As Range = worksheet1.Range("X3:X" & DETAILS_LastRow)
