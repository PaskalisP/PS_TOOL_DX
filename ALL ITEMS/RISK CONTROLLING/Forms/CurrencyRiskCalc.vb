...
Public Class CurrencyRiskCalc
    ...
    Private Sub SQL_Run_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_Run_BarButtonItem.ItemClick
        Try
            ...
            If MessageBox.Show("Should the Currency Risk calculation for " & rd & " be executed again?", "CURRENCY RISK CALCULATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
