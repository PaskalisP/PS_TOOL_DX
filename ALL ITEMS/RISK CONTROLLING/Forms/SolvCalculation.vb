...
Public Class SolvCalculation
    ...
    Private Sub SQL_Run_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_Run_BarButtonItem.ItemClick
        Try
            ...
            If MessageBox.Show("Should the CAR-Solva and Anticyclical Cap.Buffer for " & rd & " be recalculated again?", "CAR-Solva- Anticyl.Cap.Buffer calculation", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
