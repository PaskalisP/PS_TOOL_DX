        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If Me.GridControl1.FocusedView.Name = "BT_CP_Totals_GridView" Then
                    ...
                    If MessageBox.Show("Should the Business Type: " & BusinessType & " and all his details be deleted?", "DELETE BUSINESS TYPE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
