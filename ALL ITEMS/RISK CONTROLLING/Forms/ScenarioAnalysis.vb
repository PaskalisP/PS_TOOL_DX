...
Public Class ScenarioAnalysis
    ...
    Private Sub LoadData_btn_Click(sender As Object, e As EventArgs) Handles LoadData_btn.Click
        If IsDate(Me.AnalysisDate_Comboedit.Text) = True Then
            If MessageBox.Show("Should the Data for " & Me.AnalysisDate_Comboedit.Text & " be loaded?" & vbNewLine & vbNewLine & "ATTENTION! ALL SCENARIO ANALYSIS RESULTS WILL BE DELETED!", "DATA LOAD", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub ExecuteScenarioAnalysis_btn_Click(sender As Object, e As EventArgs) Handles ExecuteScenarioAnalysis_btn.Click
        If MessageBox.Show("Should the Scenario Analyis for " & Me.ScenarioAnalysisDate_lbl.Text & " be executed?" & vbNewLine & vbNewLine & "ATTENTION! ALL SCENARIO ANALYSIS RESULTS WILL BE DELETED!", "EXECUTE SCENARIO ANALYSIS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
            Try
...
#Region "CHANGE_DEFAULT_VALUES"
    Private Sub LGD_GST_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles LGD_GST_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the LGD Multiplicator default value for General Stress Test  be changed to " & Me.LGD_GST_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub Colleration_GST_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles Colleration_GST_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Colleration increase default value for General Stress Test  be changed to " & Me.Colleration_GST_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub ObligorRate_Mod_GST_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles ObligorRate_Mod_GST_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Obligor rate notches default value for General Stress Test  be changed to " & Me.ObligorRate_Mod_GST_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub LGD_CHINA_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles LGD_CHINA_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the LGD Multiplicator default value for Concentration Risk CHINA  be changed to " & Me.LGD_CHINA_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub Colleration_CHINA_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles Colleration_CHINA_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Colleration increase default value for Concentration Risk CHINA  be changed to " & Me.Colleration_CHINA_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub ObligorRate_Mod_CHINA_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles ObligorRate_Mod_CHINA_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Obligor rate notches default value for Concentration Risk CHINA  be changed to " & Me.ObligorRate_Mod_CHINA_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub LGD_FI_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles LGD_FI_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the LGD Multiplicator default value for Concentration Risk FINANCIAL INSTITUTIONS  be changed to " & Me.LGD_FI_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub Colleration_FI_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles Colleration_FI_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Colleration increase default value for Concentration Risk FINANCIAL INSTITUTION  be changed to " & Me.Colleration_FI_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
    ...
    Private Sub ObligorRate_Mod_FI_SpinEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles ObligorRate_Mod_FI_SpinEdit.ButtonClick
        If e.Button.Tag = "ChangeStandardValue" Then
            If MessageBox.Show("Should the Obligor rate notches default value for Concentration Risk FINANCIAL INSTITUTIONS  be changed to " & Me.ObligorRate_Mod_FI_SpinEdit.Text, "CHANGE DEFAULT VALUE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                Try
...
#Region "EXCEL FILE - GENERAL STRESS TEST"
    ...
    Private Sub BgwExcelLoad_General_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwExcelLoad_General.DoWork
        ...
        If dt1.Rows.Count > 0 Then
            ...
            Dim RangeDETAILS_T As Range = worksheet1.Range("T3:T" & DETAILS_LastRow)
            RangeDETAILS_T.Formula = "=S3*Totals!$H$4"
            Dim RangeDETAILS_U As Range = worksheet1.Range("U3:U" & DETAILS_LastRow)
            RangeDETAILS_U.Formula = "=M3*O3*T3"
            Dim RangeDETAILS_V As Range = worksheet1.Range("V3:V" & DETAILS_LastRow)
            RangeDETAILS_V.Formula = "=M3*O3*T3"
            Dim RangeDETAILS_Z As Range = worksheet1.Range("Z3:Z" & DETAILS_LastRow)
            ...
            Dim RangeDETAILS_AA As Range = worksheet1.Range("AA3:AA" & DETAILS_LastRow)
            RangeDETAILS_AA.Formula = "=M3*Z3"
            Dim RangeDETAILS_AB As Range = worksheet1.Range("AB3:AB" & DETAILS_LastRow)
            RangeDETAILS_AB.Formula = "=M3*O3"
            Dim RangeDETAILS_AC As Range = worksheet1.Range("AC3:AC" & DETAILS_LastRow)
        ...
        If dt.Rows.Count > 0 Then
            ...
            Dim RangeTOTALS_C As Range = worksheet.Range("C9:C" & TOTALS_LastRow)
            RangeTOTALS_C.Formula = "=COUNTIF(Details!$X$3:$X$" & DETAILS_LastRow & ";A9)"
            Dim RangeTOTALS_D As Range = worksheet.Range("D9:D" & TOTALS_LastRow)
            RangeTOTALS_D.Formula = "=SUMIF(Details!$X$3:$X$" & DETAILS_LastRow & ";A9;Details!$M$3:$M$" & DETAILS_LastRow & ")"
            Dim RangeTOTALS_F As Range = worksheet.Range("F9:F" & TOTALS_LastRow)
            ...
            Dim RangeTOTALS_G As Range = worksheet.Range("G9:G" & TOTALS_LastRow)
            RangeTOTALS_G.Formula = "=MAX(F9;0,0003)*IF(EXACT(0;F9);0;1)"
            Dim RangeTOTALS_H As Range = worksheet.Range("H9:H" & TOTALS_LastRow)
            RangeTOTALS_H.Formula = "=IF(G9-F9>0;1;0)"
            Dim RangeTOTALS_I As Range = worksheet.Range("I9:I" & TOTALS_LastRow)
            ...
            Dim RangeTOTALS_J As Range = worksheet.Range("J9:J" & TOTALS_LastRow)
            RangeTOTALS_J.Formula = "=0,12*((1-EXP(-50*G9))/(1-EXP(-50)))+0,24*(1-((1-EXP(-50*G9))/(1-EXP(-50))))"
            Dim RangeTOTALS_K As Range = worksheet.Range("K9:K" & TOTALS_LastRow)
            RangeTOTALS_K.Formula = "=J9*$H$5+J9"
            Dim RangeTOTALS_L As Range = worksheet.Range("L9:L" & TOTALS_LastRow)
            ...
            Dim RangeTOTALS_O As Range = worksheet.Range("O9:O" & TOTALS_LastRow)
            RangeTOTALS_O.Formula = "=D9/SUM($D$9:$D$" & TOTALS_LastRow & ")"
            Dim RangeTOTALS_P As Range = worksheet.Range("P9:P" & TOTALS_LastRow)
            ...
            '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            Dim RangeTOTALS_M As Range = worksheet.Range("M9:M" & TOTALS_LastRow)
            ...
            Dim RangeTOTALS_N As Range = worksheet.Range("N9:N" & TOTALS_LastRow)
            RangeTOTALS_N.Formula = "=IF(ISERROR(M9*D9*0,08);0;M9*D9*0,08)"
            Dim RangeTOTALS_Q As Range = worksheet.Range("Q9:Q" & TOTALS_LastRow)
            RangeTOTALS_Q.Formula = "=E9*G9"
            Dim RangeTOTALS_R As Range = worksheet.Range("R9:R" & TOTALS_LastRow)
            RangeTOTALS_R.Formula = "=$J$4*E9*(1-E9)"
            Dim RangeTOTALS_S As Range = worksheet.Range("S9:S" & TOTALS_LastRow)
            RangeTOTALS_S.Formula = "=IF(ISERROR((E9^2+R9)/E9);0;(E9^2+R9)/E9)"
            Dim RangeTOTALS_T As Range = worksheet.Range("T9:T" & TOTALS_LastRow)
        ...
        'Dim range1 As Range = worksheet.Range("A:AC")
        ...
        'Dim range As Range = worksheet1.Range("A:AC")
