...
Partial Class CurrencyRiskCalc
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.SQL_Run_BarButtonItem.Caption = "Currency Risk re-calculation (Current Day)"
        ...
        'PopupMenu1
        '
        Me.PopupMenu1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.SQL_Run_BarButtonItem)})
