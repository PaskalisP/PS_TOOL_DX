...
Public Class Rechnungslegung
    ...
    Private Sub Rechnungslegung_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Load_LCR_Details_btn_Click(sender As Object, e As EventArgs) Handles Load_LCR_Details_btn.Click
        If Me.LCR_Date_Comboedit.Text <> "" Then
            ...
            Try
                ...
                SplashScreenManager.Default.SetWaitFormCaption("Calculate Rechnungslegung Details" & vbNewLine & "(Stored Procedure:RECHNUNGSLEGUNG_RESTLAUFZEIT)" & vbNewLine & "for Business Date: " & rd)

                Dim da As SqlDataAdapter
                Dim objCMD As SqlCommand = New SqlCommand("execute [RECHNUNGSLEGUNG_RESTLAUFZEIT]  @RISKDATE='" & rdsql & "' ", conn)
                ...
                Else
                    SplashScreenManager.CloseForm(False)
                    MessageBox.Show("There are no Data for the Rechnungslegung Details", "NO DATA", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                    Exit Sub
                End If
    ...
    Private Sub Rechnungslegung_AdvBandedGridView_RowStyle(sender As Object, e As RowStyleEventArgs) Handles Rechnungslegung_AdvBandedGridView.RowStyle
    ...
    Private Sub Rechnungslegung_AdvBandedGridView_ShownEditor(sender As Object, e As EventArgs) Handles Rechnungslegung_AdvBandedGridView.ShownEditor
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "RECHNUNGSLEGUNG DETAILS" & "    " & "Business Date: " & rd
        e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    End Sub

    Private Sub LCR_Date_Comboedit_EditValueChanged(sender As Object, e As EventArgs) Handles LCR_Date_Comboedit.EditValueChanged
        Me.GridControl4.DataSource = Nothing
    End Sub
End Class