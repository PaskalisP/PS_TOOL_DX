...
Public Class AssetsEncumbrance
    ...
    Private Sub AssetsEncumbrance_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Load_LCR_Details_btn_Click(sender As Object, e As EventArgs) Handles Load_LCR_Details_btn.Click
        If Me.LCR_Date_Comboedit.Text <> "" Then
            ...
            Try
                ...
                SplashScreenManager.Default.SetWaitFormCaption("Calculate AESS Details (Stored Procedure:ASSETS_ENCUMBRANCE_CALC)" & vbNewLine & "for Business Date: " & rd)

                If cmd.Connection.State = ConnectionState.Closed Then
                    cmd.Connection.Open()
                End If
                cmd.CommandTimeout = 5000
                cmd.CommandText = "execute [RECHNUNGSLEGUNG_RESTLAUFZEIT] @RISKDATE = '" & rdsql & "'"
                cmd.ExecuteNonQuery()
                ...
                Dim objCMD As SqlCommand = New SqlCommand("execute ASSETS_ENCUMBRANCE_CALC  @RISKDATE='" & rdsql & "' ", conn)
                ...
                Else
                    SplashScreenManager.CloseForm(False)
                    MessageBox.Show("There are no Data for the AESS Details", "NO DATA", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                    Exit Sub
                End If
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "ASSET ENCUMBRANCE DETAILS" & "    " & "Business Date: " & rd
