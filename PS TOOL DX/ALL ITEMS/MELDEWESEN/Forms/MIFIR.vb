...
#End Region
    ...
    Private Sub MIFIR_CSV_FILE_CREATION()
        ...
        If MessageBox.Show("The MiFIR Reporting CSV File for Trade date " & rd & " is created in the directory" & vbNewLine _
                & CSV_CreationFolderDirectory & rdsql & vbNewLine & "CSV FILE NAME: " & CSV_FILE_NAME & vbNewLine & "Should the directory be oppened?", "MIFIR CSV FILE CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub CSV_VIA_EMAIL()
        ...
        If System.IO.Directory.Exists(CSV_CreationFolderDirectory & rdsql) Then
            If MessageBox.Show("Should the MIFIR CSV File for Trade Date: " & rd & " be send to the responsible Persons via Email?", "MIFIR CSV FILE EMAIL", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                Try
