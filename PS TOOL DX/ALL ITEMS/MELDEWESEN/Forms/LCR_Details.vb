...
Public Class LCR_Details
    ...
    Private Sub LCR_Details_GridView_DoubleClick(sender As Object, e As EventArgs) Handles LCR_Details_GridView.DoubleClick
        Dim view As GridView = CType(sender, GridView)
        If view.FocusedRowHandle <> DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            If view.FocusedColumn.FieldName = "Client Nr." Then
                Dim ClientNr As String = view.GetRowCellValue(view.FocusedRowHandle, "Client Nr.").ToString
