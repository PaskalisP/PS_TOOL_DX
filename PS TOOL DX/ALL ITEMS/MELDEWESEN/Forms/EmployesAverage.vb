...
Public Class EmployesAverage
    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.EndEdit Then
            ...
            If MessageBox.Show("Should the Changes be saved?", "SAVE CHANGES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                Try
                    Me.Validate()
                    Me.EMPLOYES_YEAR_AVERAGEBindingSource.EndEdit()
    ...
    Private Sub EmployesAverage_BasicView_RowUpdated(sender As Object, e As RowObjectEventArgs) Handles EmployesAverage_BasicView.RowUpdated
        If MessageBox.Show("Should the Changes be saved?", "SAVE CHANGES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
            Try
                Me.Validate()
                Me.EMPLOYES_YEAR_AVERAGEBindingSource.EndEdit()
