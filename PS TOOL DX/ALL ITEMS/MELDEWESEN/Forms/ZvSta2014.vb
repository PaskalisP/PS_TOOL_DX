...
Public Class ZvSta2014
    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.Tag = "AddNew" Then
            If MessageBox.Show("Soll ein neues Meldejahr für die ZV STATISTIK erstellt werden?", "NEUES MELDEJAHR", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If Me.GridControl2.FocusedView.Name = "ZVSTAT_BasicParameters_GridView" Then
                    ...
                    If MessageBox.Show("Should the Meldeshchema Form: " & FormNr & " be deleted?", "DELETE MELDESCHEMA FORM", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub SQL_Run_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_Run_BarButtonItem.ItemClick
        If Me.ReportLocked_CheckEdit.CheckState = CheckState.Unchecked Then
            If Me.ZvStatMeldejahr_Comboboxedit.Text <> "" Then
                If MessageBox.Show("Should the ZV STATISTIC SQL Commands for Meldejahr " & Me.ZvStatMeldejahr_Comboboxedit.Text & " be executed again?", "SQL COMMANDS EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub SQL_ReRun_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_ReRun_BarButtonItem.ItemClick
        If Me.ReportLocked_CheckEdit.CheckState = CheckState.Unchecked Then
            If Me.ZvStatMeldejahr_Comboboxedit.Text <> "" Then
                If MessageBox.Show("Should the ZV STATISTIC SQL Commands for Meldejahr " & Me.ZvStatMeldejahr_Comboboxedit.Text & " be Re-executed again?", "SQL COMMANDS RE-EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub CreateZvStatXMLfile_btn_Click(sender As Object, e As EventArgs) Handles CreateZvStatXMLfile_btn.Click
        If Me.ReportLocked_CheckEdit.CheckState = CheckState.Unchecked Then
            ...
            If XML_CREATE = "N" AndAlso SUPER_USER = "N" Then
                ...
                Exit Sub
            Else
                If MessageBox.Show("Should the XML File for the annual payments statistic report be generated ?", "XML FILE CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                    Try
