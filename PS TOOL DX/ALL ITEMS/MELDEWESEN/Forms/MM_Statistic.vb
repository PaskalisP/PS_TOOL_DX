...
#Region "CHANGE_VIEWS"
    ...
    Protected Sub ShowDetail(ByVal rowHandle As Integer)
        ...
        ElseIf ActiveTabGroup = 1 Then
            ...
            SynchronizeOrdersDetailView(datasourceRowIndex)
            GridControl3.UseEmbeddedNavigator = False
            View_Details_btn.Text = strHideExtendedMode
            fExtendedEditMode = (GridControl3.MainView Is FXSW_LayoutView)
        ElseIf ActiveTabGroup = 2 Then
            ...
            GridControl4.MainView = BGMM_LayoutView
            SynchronizeOrdersDetailView(datasourceRowIndex)
            GridControl4.UseEmbeddedNavigator = False
            View_Details_btn.Text = strHideExtendedMode
            fExtendedEditMode = (GridControl4.MainView Is BGMM_LayoutView)
        ElseIf ActiveTabGroup = 3 Then
            ...
            SynchronizeOrdersDetailView(datasourceRowIndex)
            GridControl5.UseEmbeddedNavigator = False
            View_Details_btn.Text = strHideExtendedMode
            fExtendedEditMode = (GridControl5.MainView Is EORW_LayoutView)
        End If
    ...
    Private Sub BGMM_LayoutView_MouseWheel(sender As Object, e As MouseEventArgs) Handles BGMM_LayoutView.MouseWheel
        TryCast(e, DevExpress.Utils.DXMouseEventArgs).Handled = True
    End Sub

    Private Sub FXSW_LayoutView_MouseWheel(sender As Object, e As MouseEventArgs) Handles FXSW_LayoutView.MouseWheel
        TryCast(e, DevExpress.Utils.DXMouseEventArgs).Handled = True
    End Sub

    Private Sub UGMM_LayoutView_MouseWheel(sender As Object, e As MouseEventArgs) Handles UGMM_LayoutView.MouseWheel
        TryCast(e, DevExpress.Utils.DXMouseEventArgs).Handled = True
    End Sub

    Private Sub EORW_LayoutView_MouseWheel(sender As Object, e As MouseEventArgs) Handles EORW_LayoutView.MouseWheel
        TryCast(e, DevExpress.Utils.DXMouseEventArgs).Handled = True
    End Sub
#End Region
...
#End Region
    ...
    Private Sub LoadStatisticData_btn_Click(sender As Object, e As EventArgs)
...
#Region "REPORT DATE CLICK EVENTS"
    Private Sub ReportDateEdit_Click(sender As Object, e As EventArgs) Handles ReportDateEdit.Click
        If IsDate(Me.ReportDateEdit.Text) = True Then
            ...
            'Me.ReportDateEdit.Properties.Buttons.Item(2).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(3).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(4).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(5).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(6).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(7).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(8).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(9).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(10).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(11).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(12).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(13).Visible = False
            'Me.ReportDateEdit.Properties.Buttons.Item(14).Visible = False

        End If
    End Sub

    Private Sub ReportDateEdit_Leave(sender As Object, e As EventArgs) Handles ReportDateEdit.Leave
        'Me.ReportDateEdit.Properties.Buttons.Item(0).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(1).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(2).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(3).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(4).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(5).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(6).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(7).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(8).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(9).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(10).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(11).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(12).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(13).Appearance.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(14).Appearance.ForeColor = DefaultForeColor
    ...
    Private Sub ReportDateEdit_GotFocus(sender As Object, e As EventArgs) Handles ReportDateEdit.GotFocus
        'Me.ReportDateEdit.Properties.Buttons.Item(0).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(0).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(1).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(1).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(2).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(2).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(3).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(3).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(4).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(4).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(5).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(5).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(6).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(6).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(7).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(7).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(8).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(8).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(9).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(9).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(10).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(10).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(11).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(11).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(12).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(12).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(13).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(13).AppearanceHovered.ForeColor = DefaultForeColor
        'Me.ReportDateEdit.Properties.Buttons.Item(14).Appearance.ForeColor = Color.Black
        'Me.ReportDateEdit.Properties.Buttons.Item(14).AppearanceHovered.ForeColor = DefaultForeColor
    ...
    Private Sub ReportDateEdit_TextChanged(sender As Object, e As EventArgs) Handles ReportDateEdit.TextChanged
        If IsDate(Me.ReportDateEdit.Text) = True Then
            'Me.ReportDateEdit.Properties.Buttons.Item(2).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(3).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(4).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(5).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(6).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(7).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(8).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(9).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(10).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(11).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(12).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(13).Visible = True
            'Me.ReportDateEdit.Properties.Buttons.Item(14).Visible = True
            ...
            If dt.Rows.Count > 0 Then 'MM DEALS PRESENT
                ...
                If dt1.Rows.Count > 0 Then 'LEI CODE PRESENT
                    For i = 0 To dt1.Rows.Count - 1
                        ...
                        .WriteElementString("message", "RateTp", Nothing, dt1.Rows.Item(i).Item("RateType"))
                        If dt1.Rows.Item(i).Item("RateType").ToString = "FIXE" Then
                            .WriteElementString("message", "DealRate", Nothing, dt1.Rows.Item(i).Item("DealRate").ToString.Replace(",", "."))
                        ElseIf dt1.Rows.Item(i).Item("RateType").ToString = "VARI" Then
...
#End Region
                                ...
                                If Me.BGMM_Result_lbl.Text <> "" AndAlso Me.UGMM_Result_lbl.Text <> "" AndAlso Me.FXSW_Result_lbl.Text <> "" AndAlso Me.EORW_Result_lbl.Text <> "" Then
                                    ...
                                    Else
                                        ...
                                        If dt1.Rows.Count > 0 Then 'FX SWAP NO VALID
                                            ...
                                            Exit Sub
                                        Else 'VALIDITY OK
                                            If XtraMessageBox.Show("Should a new XML File for the Money Market Statistic (Geldmarktstatistik) - Unsecured Transactions on " & rd & " be created?", "XML GELDMARKTSTATISTIK NEW FILE CREATION FOR UNSECURED TRANSACTIONS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                                Try
                                                ...
                                                If XtraMessageBox.Show("The New MM Statistic XML File for Unsecured Transactions with reporting date " & rd & " are created in the directory" & vbNewLine _
                                                    & XML_CREATION_FOLDER_FILE & rdsql & vbNewLine & vbNewLine & "File Name for Upload via Extranet:" & UGMM_XML_file & vbNewLine & vbNewLine & "Should the directory be oppened?", "XML FILES CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                ...
                                If Me.BGMM_Result_lbl.Text <> "" AndAlso Me.UGMM_Result_lbl.Text <> "" AndAlso Me.FXSW_Result_lbl.Text <> "" AndAlso Me.EORW_Result_lbl.Text <> "" Then
                                    ...
                                    Else
                                        ...
                                        If dt1.Rows.Count > 0 Then 'FX SWAP NO VALID
                                            ...
                                            Exit Sub
                                        Else 'VALIDITY OK
                                            If XtraMessageBox.Show("Should a new XML File for the Money Market Statistic (Geldmarktstatistik) - FX Swaps Transactions on " & rd & " be created?", "XML GELDMARKTSTATISTIK NEW FILE CREATION FOR FX SWAPS TRANSACTIONS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                                Try
                                                    If XSD_VERSION = "01" Then
                                                        XML_FXSW_CREATION()
                                                    ElseIf XSD_VERSION = "02" Then
                                                ...
                                                If XtraMessageBox.Show("The New MM Statistic XML File for FX Swaps Transactions with reporting date " & rd & " are created in the directory" & vbNewLine _
                                                    & XML_CREATION_FOLDER_FILE & rdsql & vbNewLine & vbNewLine & "File Name for Upload via Extranet:" & FXSW_XML_file & vbNewLine & vbNewLine & "Should the directory be oppened?", "XML FILES CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                                    System.Diagnostics.Process.Start(XML_CREATION_FOLDER_FILE & rdsql)
                                                End If
    ...
    Private Sub AdditionalDataQualityChecks()
        Try
    ...
    Private Sub MoneyMarketStatisticReport()
        Dim RM As Date = Me.ReportDateEdit.Text
        SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                                ...
                                If Me.BGMM_Result_lbl.Text <> "" AndAlso Me.UGMM_Result_lbl.Text <> "" AndAlso Me.FXSW_Result_lbl.Text <> "" AndAlso Me.EORW_Result_lbl.Text <> "" Then
                                    ...
                                    Else
                                        ...
                                        If dt1.Rows.Count > 0 Then 'FX SWAP NO VALID
                                            ...
                                            Exit Sub
                                        Else 'VALIDITY OK
                                            If XtraMessageBox.Show("Should the 4 XML Files for the Money Market Statistic (Geldmarktstatistik) on " & rd & " be created?", "XML GELDMARKTSTATISTIK FILES CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                                'XML Folder creation
                                                Try
                                                    XML_FOLDER_CREATION()
                                                Catch ex As Exception
                                                ...
                                                If XtraMessageBox.Show("The MM Statistic XML Files for reporting date " & rd & " are created in the directory" & vbNewLine _
                                                    & XML_CREATION_FOLDER_FILE & rdsql & vbNewLine & vbNewLine & "Should the directory be oppened?", "XML FILES CREATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                                                    System.Diagnostics.Process.Start(XML_CREATION_FOLDER_FILE & rdsql)
                                                End If
    ...
    Private Sub CheckReportResults()
        Try
            If Me.ReportLocked_CheckEdit.CheckState = CheckState.Unchecked Then
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                If cmd.Connection.State = ConnectionState.Closed Then
    ...
    Private Sub ReportDateEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles ReportDateEdit.ButtonClick
        If e.Button.Tag.ToString = "AdditionalDataQualityChecks" Then
            AdditionalDataQualityChecks()
        End If

        If e.Button.Tag.ToString = "MoneyMarketStatisticReport" Then
            MoneyMarketStatisticReport()
        End If

        If e.Button.Tag.ToString = "PrintOrExport" Then
            PrintOrExport()
        End If

        If e.Button.Tag.ToString = "LoadData" Then
            LoadData()
        End If

        If e.Button.Tag.ToString = "CreateXMLFiles" Then
            CreateXMLFiles()
        End If

        If e.Button.Tag.ToString = "OpenXMLFilesFolder" Then
            Dim rd As Date = Me.ReportDateEdit.Text
            Dim rdsql As String = rd.ToString("yyyyMMdd")
            If Not System.IO.Directory.Exists(XML_CREATION_FOLDER_FILE & rdsql) Then
                XtraMessageBox.Show("The Folder: " & XML_CREATION_FOLDER_FILE & rdsql & " does not exist!!" & vbNewLine & "Please first create the XML Files!", "FOLDER NOT EXISTING", MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        If e.Button.Tag.ToString = "CheckReportResults" Then
            CheckReportResults()
        End If

    End Sub

    Private Sub UGMM_LayoutView_DoubleClick(sender As Object, e As EventArgs) Handles UGMM_LayoutView.DoubleClick
        Dim args As MouseEventArgs = TryCast(e, MouseEventArgs)
        Dim view As DevExpress.XtraGrid.Views.Layout.LayoutView = TryCast(sender, DevExpress.XtraGrid.Views.Layout.LayoutView)
        Dim hi As LayoutViewHitInfo = view.CalcHitInfo(args.Location)
        If hi.InField AndAlso hi.Column.FieldName = "OCBS_Cust_Nr" Then
            Dim ClientNr As String = view.GetRowCellValue(view.FocusedRowHandle, "OCBS_Cust_Nr").ToString
    ...
    Private Sub FXSW_LayoutView_DoubleClick(sender As Object, e As EventArgs) Handles FXSW_LayoutView.DoubleClick
        Dim args As MouseEventArgs = TryCast(e, MouseEventArgs)
        Dim view As DevExpress.XtraGrid.Views.Layout.LayoutView = TryCast(sender, DevExpress.XtraGrid.Views.Layout.LayoutView)
        Dim hi As LayoutViewHitInfo = view.CalcHitInfo(args.Location)
        If hi.InField AndAlso hi.Column.FieldName = "OCBS_Cust_Nr" Then
