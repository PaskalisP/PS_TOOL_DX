...
Public Class MappingDiverseGL
    ...
    Private Sub DIVERSE_GL_ITEMSBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
        Me.DIVERSE_GL_ITEMSBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.BalancesDataset)

    End Sub

    Private Sub MappingDiverseGL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GridControl1_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.EndEdit Then
            Try
                Me.Validate()
                Me.DIVERSE_MAPPINGBindingSource.EndEdit()
                Me.DIVERSE_GL_ITEMSBindingSource.EndEdit()
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If Me.GridControl1.FocusedView.Name = "DIVERSE_GLitems_View" Then
                Dim row As System.Data.DataRow = DIVERSE_GLitems_View.GetDataRow(DIVERSE_GLitems_View.FocusedRowHandle)
                Dim h As Integer = FindRowHandleByRowObject(DIVERSE_GLitems_View, row)
                ...
                If MessageBox.Show("Should the GENERAL LEDGER NR. " & cellvalue & " and all its mapped GL Accounts be deleted ?", "DELETE GENERAL LEDGER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = MsgBoxResult.Yes Then
                    ...
                    cmd.CommandText = "DELETE FROM [DIVERSE_MAPPING] where [GL_ITEM_Mapped]='" & cellvalue & "'"
                    cmd.ExecuteNonQuery()
                    'Delete GL Item Nr.
                    cmd.CommandText = "DELETE  FROM [DIVERSE_GL_ITEMS] where [GL_ITEM_NR]='" & cellvalue & "'"
                    cmd.ExecuteNonQuery()
                    cmd.Connection.Close()
                    Me.DIVERSE_GLitems_View.DeleteSelectedRows()
                    GridControl1.Update()
                Else
                    e.Handled = True
                End If
            ElseIf Me.GridControl1.FocusedView.Name = "MappedGLaccounts_BaseView" Then
                If MessageBox.Show("Should the mapped GL Account Nr. " & IdRowValue & " be deleted ? ", "DELETE MAPPED GL ACCOUNT", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Dim GLAccountDelete As BalancesDataset.DIVERSE_MAPPINGRow
                    GLAccountDelete = BalancesDataset.DIVERSE_MAPPING.FindByGL_ACC_Nr(IdRowValue)
    ...
    Private Sub DIVERSE_GLitems_View_FocusedRowChanged(sender As Object, e As FocusedRowChangedEventArgs) Handles DIVERSE_GLitems_View.FocusedRowChanged
        If Me.DIVERSE_GLitems_View.IsNewItemRow(Me.DIVERSE_GLitems_View.FocusedRowHandle) = True Then
            Me.DIVERSE_GLitems_View.Columns.ColumnByFieldName("GL_ITEM_NR").OptionsColumn.ReadOnly = False
        Else
            Me.DIVERSE_GLitems_View.Columns.ColumnByFieldName("GL_ITEM_NR").OptionsColumn.ReadOnly = True
        End If
    End Sub
    ...
    Private Sub DIVERSE_GLitems_View_MasterRowExpanded(sender As Object, e As CustomMasterRowEventArgs) Handles DIVERSE_GLitems_View.MasterRowExpanded
        If Me.GridControl1.FocusedView.Name = "DIVERSE_GLitems_View" Then
            Dim view As GridView = DirectCast(sender, GridView)
    ...
    Private Sub DIVERSE_GLitems_View_MasterRowExpanding(sender As Object, e As MasterRowCanExpandEventArgs) Handles DIVERSE_GLitems_View.MasterRowExpanding
        If Me.GridControl1.FocusedView.Name = "DIVERSE_GLitems_View" Then
            Dim view As GridView = DirectCast(sender, GridView)
            DetailsViewCaption = "Mapped General Ledger Accounts for GL ITEM: " & view.GetFocusedRowCellValue("GL_ITEM_NR").ToString & " (" & view.GetFocusedRowCellValue("GL_ITEM_NAME").ToString & ")"
            Me.MappedGLaccounts_BaseView.ViewCaption = DetailsViewCaption
    ...
    Private Sub DIVERSE_GLitems_View_RowClick(sender As Object, e As RowClickEventArgs) Handles DIVERSE_GLitems_View.RowClick
        If Me.GridControl1.FocusedView.Name = "DIVERSE_GLitems_View" Then
            Dim view As GridView = DirectCast(sender, GridView)
            DetailsViewCaption = "Mapped General Ledger Accounts for GL ITEM: " & view.GetFocusedRowCellValue("GL_ITEM_NR").ToString & " (" & view.GetFocusedRowCellValue("GL_ITEM_NAME").ToString & ")"
            Me.MappedGLaccounts_BaseView.ViewCaption = DetailsViewCaption
    ...
    Private Sub DIVERSE_GLitems_View_RowStyle(sender As Object, e As RowStyleEventArgs) Handles DIVERSE_GLitems_View.RowStyle
    ...
    Private Sub DIVERSE_GLitems_View_ShownEditor(sender As Object, e As EventArgs) Handles DIVERSE_GLitems_View.ShownEditor
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "MAPPING OF DIVERSE GENERAL LEDGER ITEMS"
