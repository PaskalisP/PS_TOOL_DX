...
Public Class CustomerBalancesNEWG
    ...
    Private Sub BgwLoadPostings_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwLoadPostings.DoWork
        Try
            If IsNothing(Me.Account_LookUpEdit.Text) = False AndAlso IsNumeric(Me.Account_LookUpEdit.Text) = True Then
                Me.BgwLoadPostings.ReportProgress(10, "Load  Balances for Customer Account: " & Me.Account_LookUpEdit.Text & " from: " & d1 & " till " & d2)
 ...
 'Dim pinfoBrick As PageInfoBrick, r As RectangleF, iSize As Size
    ...
    Private Sub CustomerBalancesNEWG_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
