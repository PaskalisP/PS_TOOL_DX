...
Public Class CustomerBalancesNEWG
    ...
    Private Sub CustomerBalancesNEWG_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FILL_ONE_ACCOUNT_DATATABLE()
        ...
        query.Sql = "SELECT * FROM   [CUSTOMER_ACC_BALANCES] WHERE  (AccountNo = '" & Me.Account_LookUpEdit.Text & "') AND ([BalanceDate] >= '" & rdsql1 & "') AND ([BalanceDate] <= '" & rdsql2 & "') and [AccountType] in ('Current account') ORDER BY [BalanceDate] asc"
    ...
    Private Sub FILL_ALL_ACCOUNTS_DATATABLE()
        ...
        query.Sql = "SELECT * FROM   [CUSTOMER_ACC_BALANCES] WHERE   ([BalanceDate] >= '" & rdsql1 & "') AND ([BalanceDate] <= '" & rdsql2 & "') and [AccountType] in ('Current account') ORDER BY [BalanceDate] asc"
            ...
            If d2 >= d1 Then
                ...
                If Me.Account_LookUpEdit.Text <> "" Then ' AndAlso IsNumeric(Me.Account_LookUpEdit.Text) = True Then
                    Try
                        ...
                        SplashScreenManager.Default.SetWaitFormCaption("Load  Balances for Customer Account: " & Me.Account_LookUpEdit.Text & " from: " & d1 & " till " & d2)
                        ...
                        Me.SearchText_lbl.Text = "Balances for Customer Account: " & Me.Account_LookUpEdit.Text & " -Currency: " & OCBSaccountCurlbl & " from " & d1 & " till " & d2 & "  - Account Status: " & dt.Rows.Item(0).Item("Account Status")
                ...
                Else
                    Try
                        ...
                        SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                        SplashScreenManager.Default.SetWaitFormCaption("Load  Balances for all Customer Accounts from: " & d1 & " till " & d2)
