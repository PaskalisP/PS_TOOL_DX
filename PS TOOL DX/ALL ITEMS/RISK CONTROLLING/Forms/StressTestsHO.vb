...
Public Class StressTestsHO
    ...
    Private Sub SQL_Run_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_Run_BarButtonItem.ItemClick
        If XtraMessageBox.Show("Should the Stress Test H.O. scenario for the current Day be executed again?", "Stress Test H.O. scenario (Current day) EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub SQL_ReRun_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_ReRun_BarButtonItem.ItemClick
        If XtraMessageBox.Show("Should the Stress Test H.O. scenario be executed again?", "Stress Test H.O. scenario (Current day) RE-EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub SQL_ReRun_AllDays_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SQL_ReRun_AllDays_BarButtonItem.ItemClick
        If XtraMessageBox.Show("Should the Stress Test H.O. scenario for all Days be deleted and executed again?", "Stress Test H.O. scenario (ALL DAYS) RE-EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub dxOK_click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If IsDate(DATES_FORM.DateEdit1.Text) = True And IsDate(DATES_FORM.DateEdit2.Text) = True Then
            ...
            If FDate <= FDate Then
                If XtraMessageBox.Show("Should the H.O. Stress Test scenario for the indicated Period:" & vbNewLine & FDate & " till " & LDate & vbNewLine & "be executed?", "H.O. STRESS TEST SCENARIO EXECUTION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
