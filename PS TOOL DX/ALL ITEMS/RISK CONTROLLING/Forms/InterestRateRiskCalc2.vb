...
Public Class InterestRateRiskCalc2
    ...
    Private Sub InterestRateRiskCalc2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.RATERISK_TOTALS1TableAdapter.FillByRATERISK_TOTALS_FILL(Me.RiskControllingDataSet.RATERISK_TOTALS1, d)
    ...
    Private Sub InterestRateRiskDateEdit_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles InterestRateRiskDateEdit.ButtonClick
        If e.Button.Caption = "Reload" Then
            ...
            If IsDate(Me.InterestRateRiskDateEdit.Text) = True Then
                ...
                Me.RATERISK_DELETIONSTableAdapter.FillByRiskDate(Me.RiskControllingDataSet.RATERISK_DELETIONS, d)
                Me.RATERISK_TOTALS1TableAdapter.FillByRiskDate(Me.RiskControllingDataSet.RATERISK_TOTALS1, d)
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "INTEREST RATE RISK (TOTALS) - Calculation 2 " & "   " & "on: " & Me.InterestRateRiskDateEdit.Text
