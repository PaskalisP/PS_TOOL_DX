...
'Description:
'Modify log:  
'    1. Add by WYQ; Time:10.06.2022; Content: BAIS system version is updated to Version 1.34. Add the BaisExportAlphaV134 class for Bais Version 1.34

'******************************************
Public Class BaisExportAlphaV134
    ...
    Private Sub BaisExportAlphaV134_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAlphaV134_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_v1.34_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.RichEditControl1.Text = Me.RichEditControl1.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_v1.34_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
                    ...
                    If ParameterStatus = "Y" Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                                BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_COMMON_INTERFACE_FILES_V1.34/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                                cmd.ExecuteNonQuery()
                            End If
                        Next
                    End If
    ...
    Private Sub LQGIFF_CREATION()
		...
		Dim LQGIFF_INLIM As String = Nothing ' New 1.34
		Dim LQGIFF_EXLIM As String = Nothing ' New 1.34
		Dim LQGIFF_AZEZU As String = Nothing ' New 1.34
