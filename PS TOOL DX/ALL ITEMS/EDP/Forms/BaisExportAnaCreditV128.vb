...
Public Class BaisExportAnaCreditV128
    ...
    Private Sub BaisExportAnaCreditV128_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAnaCreditV128_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_AnaCredit_v1.28_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_AnaCredit_v1.28_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
    ...
    Private Sub ACCPIF_CREATION()
            ...
            Try
                ...
                If ParameterStatus = "Y" Then
                    ...
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        cmd.CommandText = SqlCommandText
                        If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                            BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACCPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                            cmd.ExecuteNonQuery()
                        End If
                    Next
                End If
                ...
                Dim ACCPIF_DETAX As String = Nothing 'New Version 1.28
                Dim ACCPIF_DETST As String = Nothing 'New Version 1.28
                Dim ACCPIF_DEVAT As String = Nothing 'New Version 1.28
                Dim ACCPIF_DEVST As String = Nothing 'New Version 1.28
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    ACCPIF_DETAX = dt.Rows.Item(i).Item("ACCPIF_DETAX") & "|"
                    ACCPIF_DETST = dt.Rows.Item(i).Item("ACCPIF_DETST") & "|"
                    ACCPIF_DEVAT = dt.Rows.Item(i).Item("ACCPIF_DEVAT") & "|"
                    ACCPIF_DEVST = dt.Rows.Item(i).Item("ACCPIF_DEVST") & "|"
                    ...
                    CSV_ROW = ACCPIF_MDANT & ACCPIF_ARAID & ACCPIF_ACPTP & ACCPIF_ACPID & ACCPIF_KDNMD & ACCPIF_FILNR & ACCPIF_DUBID & ACCPIF_DUBST & ACCPIF_LENID & ACCPIF_LENST & ACCPIF_ANATP & ACCPIF_ANATS & ACCPIF_ANAID & ACCPIF_ANAST & ACCPIF_DETAX & ACCPIF_DETST & ACCPIF_DEVAT & ACCPIF_DEVST & ACCPIF_ARIAD & ACCPIF_RIAST & ACCPIF_ACBLZ & ACCPIF_BLZST & ACCPIF_KGBID & ACCPIF_KGBST & ACCPIF_KNMID & ACCPIF_KNMST & ACCPIF_ISINR & ACCPIF_ISIST & ACCPIF_BKBIC & ACCPIF_BICST & ACCPIF_ACBAK & ACCPIF_BAKST & ACCPIF_ACFVC & ACCPIF_FVCST & ACCPIF_ACIFS & ACCPIF_IFSST & ACCPIF_AVOID & ACCPIF_AVOST & ACCPIF_BLOTC & ACCPIF_BLOST & ACCPIF_BVDCD & ACCPIF_BVDST & ACCPIF_DESTA & ACCPIF_DESST & ACCPIF_DUNID & ACCPIF_DUNST & ACCPIF_EIOID & ACCPIF_EIOST & ACCPIF_ELEID & ACCPIF_ELEST & ACCPIF_HOUTP & ACCPIF_HOTST & ACCPIF_HOUID & ACCPIF_HOUST & ACCPIF_IPUTP & ACCPIF_IPTST & ACCPIF_IPUID & ACCPIF_IPUST & ACCPIF_AUPTP & ACCPIF_AUTST & ACCPIF_AUPID & ACCPIF_AUPST & ACCPIF_KNAME & ACCPIF_KNAST & ACCPIF_STRAS & ACCPIF_STRST & ACCPIF_PLZOR & ACCPIF_PLZST & ACCPIF_KREIS & ACCPIF_KREST & ACCPIF_PLZNR & ACCPIF_PLNST & ACCPIF_LDISO & ACCPIF_LDIST & ACCPIF_ARECH & ACCPIF_RECST & ACCPIF_AINSE & ACCPIF_AINST & ACCPIF_BRNCH & ACCPIF_BRNST & ACCPIF_NACES & ACCPIF_NACST & ACCPIF_ASOLP & ACCPIF_ASOST & ACCPIF_DXOLP & ACCPIF_DXOST & ACCPIF_AENSI & ACCPIF_AENST & ACCPIF_DXNSI & ACCPIF_DXNST & ACCPIF_MITAR & ACCPIF_MITST & ACCPIF_BILSU & ACCPIF_BILST & ACCPIF_UMMIO & ACCPIF_UMMST & ACCPIF_BILAR & ACCPIF_BIAST & ACCPIF_RESE1 & ACCPIF_RESE2 & ACCPIF_RESE3 & ACCPIF_FREI1 & ACCPIF_FREI2 & ACCPIF_FREI3 & ACCPIF_FREI4 & ACCPIF_FREI5 & ACCPIF_LOEKZ & ACCPIF_IFNAM & ACCPIF_DXIFD
        ...
        Else
            ...
            End If
            Me.ACCPIF_Result = "Not Created"
            Dim CSV_HEADER As String = "ACCPAF_MDANT|ACCPAF_ARAID|ACCPAF_ACPTP|ACCPAF_ACPID|ACCPAF_KDREA|ACCPAF_FILNR|ACCPAF_DUBID|ACCPAF_DUBST|ACCPAF_LENID|ACCPAF_LENST|ACCPAF_ANATP|ACCPAF_ANATS|ACCPAF_ANAID|ACCPAF_ANAST|ACCPAF_ARIAD|ACCPAF_RIAST|ACCPAF_ACBLZ|ACCPAF_BLZST|ACCPAF_KGBID|ACCPAF_KGBST|ACCPAF_KNMID|ACCPAF_KNMST|ACCPAF_ISINR|ACCPAF_ISIST|ACCPAF_BKBIC|ACCPAF_BICST|ACCPAF_ACBAK|ACCPAF_BAKST|ACCPAF_ACFVC|ACCPAF_FVCST|ACCPAF_ACIFS|ACCPAF_IFSST|ACCPIF_AVOID|ACCPIF_AVOST|ACCPIF_BLOTC|ACCPIF_BLOST|ACCPIF_BVDCD|ACCPIF_BVDST|ACCPIF_DESTA|ACCPIF_DESST|ACCPIF_DUNID|ACCPIF_DUNST|ACCPIF_EIOID|ACCPIF_EIOST|ACCPIF_ELEID|ACCPIF_ELEST|ACCPAF_HOUTP|ACCPAF_HOTST|ACCPAF_HOUID|ACCPAF_HOUST|ACCPAF_IPUTP|ACCPAF_IPTST|ACCPAF_IPUID|ACCPAF_IPUST|ACCPAF_AUPTP|ACCPAF_AUTST|ACCPAF_AUPID|ACCPAF_AUPST|ACCPAF_KNAME|ACCPAF_KNAST|ACCPAF_STRAS|ACCPAF_STRST|ACCPAF_PLZOR|ACCPAF_PLZST|ACCPAF_KREIS|ACCPAF_KREST|ACCPAF_PLZNR|ACCPAF_PLNST|ACCPAF_LDISO|ACCPAF_LDIST|ACCPAF_ARECH|ACCPAF_RECST|ACCPAF_AINSE|ACCPAF_AINST|ACCPAF_BRNCH|ACCPAF_BRNST|ACCPAF_NACES|ACCPAF_NACST|ACCPAF_ASOLP|ACCPAF_ASOST|ACCPAF_DXOLP|ACCPAF_DXOST|ACCPAF_AENSI|ACCPAF_AENST|ACCPAF_DXNSI|ACCPAF_DXNST|ACCPAF_MITAR|ACCPAF_MITST|ACCPAF_BILSU|ACCPAF_BILST|ACCPAF_UMMIO|ACCPAF_UMMST|ACCPAF_BILAR|ACCPAF_BIAST|ACCPAF_RESE1|ACCPAF_RESE2|ACCPAF_RESE3|ACCPAF_FREI1|ACCPAF_FREI2|ACCPAF_FREI3|ACCPAF_FREI4|ACCPAF_FREI5|ACCPAF_LOEKZ|ACCPAF_IFNAM|ACCPAF_DXIFD"
            Dim CSV_ROW As String = Nothing
            If File.Exists(BaisFilesCreationPath & "ACCPAF_CCB.csv") = True Then
                File.Delete(BaisFilesCreationPath & "ACCPAF_CCB.csv")
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACFDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACFAIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACIPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
    ...
    Private Sub ACCFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACCFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACIFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACIFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPCIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACPCIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPDIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.28/ACPDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
