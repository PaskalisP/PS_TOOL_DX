...
Public Class BaisExportAlphaV132
    ...
    Private Sub BaisExportAlphaV132_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAlphaV132_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_v1.32_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.RichEditControl1.Text = Me.RichEditControl1.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_v1.32_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
                    ...
                    If ParameterStatus = "Y" Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                                BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_COMMON_INTERFACE_FILES_V1.32/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                                cmd.ExecuteNonQuery()
                            End If
                        Next
                    End If
    ...
    Private Sub GSTIFF_CREATION()
        ...
        Dim GSTIFF_PBDFA As String = Nothing 'New Version 1.31
        ...
        If Count > 0 Then
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    GSTIFF_PBDFA = dt.Rows.Item(i).Item("GSTIFF_PBDFA") & "|" 'New 1.31
    ...
    Private Sub ZUSIFF_CREATION()
        ...
        Dim ZUSIFF_PBDFA As String = Nothing 'New 1.31
        ...
        If Count <> 0 Then
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    ZUSIFF_PBDFA = dt.Rows.Item(i).Item("ZUSIFF_PBDFA").ToString.Replace(",", ".") & "|" 'New 1.31
    ...
    Private Sub GSWBIF_CREATION()
        ...
        Dim GSWBIF_PBABS As String = Nothing 'New 1.32
        ...
        Dim GSWBIF_ZWBB1 As String = Nothing 'New 1.32
        Dim GSWBIF_ZB1WH As String = Nothing 'New 1.32
        Dim GSWBIF_ZWBB2 As String = Nothing 'New 1.32
        Dim GSWBIF_ZB2WH As String = Nothing 'New 1.32
    ...
    Private Sub SCNTIF_CREATION()
        ...
        If Count > 0 Then
            Try
                ...
                If File.Exists(BaisFilesCreationPath & "SCNTIF_CCB.csv") = True Then
                    File.Delete(BaisFilesCreationPath & "SCNTIF_CCB.csv")
                End If
                'Create Header
                System.IO.File.AppendAllText(BaisFilesCreationPath & "SCNTIF_CCB.csv", CSV_HEADER & vbCrLf)
                '++++++++++++++
                ...
                If dt.Rows.Count > 0 Then
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        SCNTIF_KDNRH = dt.Rows.Item(i).Item("SCNTIF_KDNRH") & "|"
                        ...
                        SCNTIF_EX1WE = dt.Rows.Item(i).Item("SCNTIF_EX1WE") & "|"
                        ...
                        System.IO.File.AppendAllText(BaisFilesCreationPath & "SCNTIF_CCB.csv", CSV_ROW & vbCrLf)
                    Next
        ...
        Else
            ...
            'Create Header
            System.IO.File.AppendAllText(BaisFilesCreationPath & "SCNTIF_CCB.csv", CSV_HEADER & vbCrLf)
            XtraMessageBox.Show("Unable to create File SCNTIF_CCB.csv for " & rd & vbNewLine & "No related transactions are loaded in BAIS Tables:BAIS_DESIFF and/or BAIS_DVTIFF" & vbNewLine & " Please Check!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
    ...
    Private Sub SCDRIF_CREATION()
        ...
        If Count > 0 Then
            Try
                ...
                BgwBaisFilesCreation.ReportProgress(2, "Start creating BAIS_SCDRIF File for: " & rd)
                cmd.CommandText = "SELECT [Status] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.32') and [Id_SQL_Parameters] in ('BAIS')"
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                ...
                BgwBaisFilesCreation.ReportProgress(2, "Generating File: SCDRIF_CCB.csv .... Please wait...")


                If File.Exists(BaisFilesCreationPath & "SCDRIF_CCB.csv") = True Then
                    File.Delete(BaisFilesCreationPath & "SCDRIF_CCB.csv")
                End If
                'Create Header
                System.IO.File.AppendAllText(BaisFilesCreationPath & "SCDRIF_CCB.csv", CSV_HEADER & vbCrLf)
                '++++++++++++++
                ...
                If dt.Rows.Count > 0 Then
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        SCDRIF_KDNRH = dt.Rows.Item(i).Item("SCDRIF_KDNRH") & "|"
                        ...
                        SCDRIF_BUSYD = dt.Rows.Item(i).Item("SCDRIF_RSTWH").ToString.Replace(",", ".") & "|"
                        ...
                        SCDRIF_EX1WE = dt.Rows.Item(i).Item("SCDRIF_EX1WE") & "|"
                        ...
                        System.IO.File.AppendAllText(BaisFilesCreationPath & "SCDRIF_CCB.csv", CSV_ROW & vbCrLf)
                    Next
        ...
        Else
            ...
            'Create Header
            System.IO.File.AppendAllText(BaisFilesCreationPath & "SCDRIF_CCB.csv", CSV_HEADER & vbCrLf)
            XtraMessageBox.Show("Unable to create File SCDRIF_CCB.csv for " & rd & vbNewLine & "No related transactions are loaded in BAIS Tables:BAIS_DESIFF and/or BAIS_DVTIFF" & vbNewLine & " Please Check!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
