...
Public Class BaisExportNewest
    ...
    Private Sub BaisExportNewest_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportNewest_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub StartFileCreation_btn_Click(sender As Object, e As EventArgs) Handles StartFileCreation_btn.Click
        ...
        If IsDate(Me.BusinessDate_Comboedit.Text) = True Then
            Dim rd As Date = Me.BusinessDate_Comboedit.Text
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_v1.24_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_v1.24_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
        ...
        If CountFxDeals > 0 Then
            ...
            If Count = 0 Then
                Try
                    ...
                    cmd.CommandText = "SELECT [Status] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24') and [Id_SQL_Parameters] in ('BAIS')"
                    ParameterStatus = cmd.ExecuteScalar
                    If ParameterStatus = "Y" Then
                        Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_DVTIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                        da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                        dt = New System.Data.DataTable()
                        da.Fill(dt)
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                                BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_COMMON_INTERFACE_FILES_V1.24/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                                cmd.ExecuteNonQuery()
                            End If
                        Next
                    End If
    ...
    Private Sub GSTSLF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_GSTSLF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub BILIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_BILIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub KGCIFF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_KGCIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub KNEIFF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_KNEIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
        ...
        If Count <> 0 Then
            Try
                ...
                'New Code
                Dim CSV_HEADER As String = "KNEIFF_MDANT|KNEIFF_FILNR|KNEIFF_KDNRH|KNEIFF_KURZN|KNEIFF_NAME1|KNEIFF_NAME2|KNEIFF_NAME3|KNEIFF_PLZOR|KNEIFF_PLZNR|KNEIFF_STRAS|KNEIFF_DXGEB|KNEIFF_WSGSI|KNEIFF_BRNCH|KNEIFF_WSBIS|KNEIFF_BRNZU|KNEIFF_SLDSL|KNEIFF_RLDSL|KNEIFF_LDRIS|KNEIFF_BONIT|KNEIFF_GRPKZ|KNEIFF_KZLST|KNEIFF_KZPER|KNEIFF_UMMIO|KNEIFF_AUSFL|KNEIFF_DXAUD|KNEIFF_ORGSL|KNEIFF_RISGR|KNEIFF_KGBID|KNEIFF_ANRKZ|KNEIFF_ESAKZ|KNEIFF_ESAK2|KNEIFF_ESAK3|KNEIFF_KUKON|KNEIFF_NACES|KNEIFF_LENID|KNEIFF_WSCRR|KNEIFF_WSFIN|KNEIFF_AVCKZ|KNEIFF_RECHF|KNEIFF_KNBOG|KNEIFF_MITAR|KNEIFF_FREI1|KNEIFF_FREI2|KNEIFF_FREI3|KNEIFF_FREI4|KNEIFF_FREI5|KNEIFF_LOEKZ|KNEIFF_IFNAM|KNEIFF_DXIFD"
                Dim CSV_ROW As String = Nothing
    ...
    Private Sub KNVIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_KNVIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub KRKIFF_CREATION()
        ...
        If Count > 0 Then
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_KRKIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub KSRIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_KSRIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub LQGIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_LQGIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub MKUIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_MKUIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub ZUSIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ZUSIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub GAKIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_GAKIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub GAGIFF_CREATION()
        ...
        If Count <> 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_GAGIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub LQKIFF_CREATION()
        ...
        If Count <> 0 Then
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_LQKIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub DESIFF_CREATION()
        ...
        If Count > 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_DESIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
    ...
    Private Sub WHGIFF_CREATION()
        ...
        If Count > 0 Then
            Try
                ...
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_WHGIFF') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_COMMON_INTERFACE_FILES_V1.24'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
