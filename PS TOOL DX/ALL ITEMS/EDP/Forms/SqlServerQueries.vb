...
Public Class SqlServerQueries
    ...
    Private Sub SqlServerQueries_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F5 Then
            Me.SqlExecute_btn.PerformClick()
        End If
    End Sub
    ...
    Private Sub TreeList1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles TreeList1.MouseDoubleClick
        If Me.RichEditControl1.ReadOnly = False Then
            ...
            If Me.RichEditControl1.Text = Nothing Then
                Me.RichEditControl1.Text = result
            Else
                Me.RichEditControl1.Text = Me.RichEditControl1.Text & "  " & result
            End If
        End If
    ...
    Private Sub DISABLE_CONTROLS_ON_SQL_EXECUTION()
        ...
        Me.SqlExecute_btn.Enabled = False
        Me.SqlClear_btn.Enabled = False
        Me.SqlSave_btn.Enabled = False
        Me.SqlLoad_btn.Enabled = False
        Me.NewSqlQueryForm_btn.Enabled = False
    ...
    Private Sub ENABLE_CONTROLS_ON_SQL_EXECUTION()
        ...
        Me.SqlExecute_btn.Enabled = True
        Me.SqlClear_btn.Enabled = True
        Me.SqlSave_btn.Enabled = True
        Me.SqlLoad_btn.Enabled = True
        Me.NewSqlQueryForm_btn.Enabled = True
        ...
        If Me.RichEditControl1.Text <> "" Then
            ...
            ElseIf (s.StartsWith("DELETE")) Or (s.StartsWith("DROP TABLE")) Then
                If MsgBox("Your about to delete data/Table from the Database!!" & vbNewLine & "Should the command be processed?", MsgBoxStyle.YesNo, "DATA/TABLE DELETE COMMAND") = MsgBoxResult.Yes Then
                    Dim cmd As SqlCommand = New SqlCommand(Me.RichEditControl1.Text, conn)
                    Try
                        'SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                        'SplashScreenManager.Default.SetWaitFormCaption("Executing SQL Command...")
                        DISABLE_CONTROLS_ON_SQL_EXECUTION()
    ...
    Private Sub BgwSqlExecute_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwSqlExecute.DoWork
        Try
            da = New SqlDataAdapter(Me.RichEditControl1.Text.Trim(), conn)
    ...
    Private Sub SqlSave_btn_Click(sender As Object, e As EventArgs) Handles SqlSave_btn.Click
        If Me.RichEditControl1.Text <> "" Then
            With SaveFileDialog1
                .Filter = "Text Files|*.txt|SQL Files|*.sql"
    ...
    Private Sub SqlLoad_btn_Click(sender As Object, e As EventArgs) Handles SqlLoad_btn.Click
        With OpenFileDialog1
            .Filter = "Text Files;SQL Files|*.txt;*.sql"
            .FilterIndex = 1
            .InitialDirectory = SQL_STATEMENT_DIR
            .FileName = ""
