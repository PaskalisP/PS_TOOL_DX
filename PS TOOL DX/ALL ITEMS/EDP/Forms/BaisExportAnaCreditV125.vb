...
Public Class BaisExportAnaCreditV125
    ...
    Private Sub BaisExportAnaCreditV125_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAnaCreditV125_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub StartFileCreation_btn_Click(sender As Object, e As EventArgs) Handles StartFileCreation_btn.Click
        ...
        If IsDate(Me.BusinessDate_Comboedit.Text) = True Then
            ...
            If ACCPIF_CheckEdit.CheckState = CheckState.Checked OrElse _
                ACFDIF_CheckEdit.CheckState = CheckState.Checked OrElse _
                ACFAIF_CheckEdit.CheckState = CheckState.Checked OrElse _
                ACCFIF_CheckEdit.CheckState = CheckState.Checked OrElse _
        ...
        Try
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    ...
                    SplashScreenManager.Default.SetWaitFormCaption("Execute AnaCredit Data Check: " & dt.Rows.Item(i).Item("SQL_Name_1"))
                    Threading.Thread.Sleep(500)
                    cmd.ExecuteNonQuery()
                End If
            Next
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_AnaCredit_v1.25_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_AnaCredit_v1.25_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
    ...
    Private Sub ACCPIF_CREATION()
        ...
        If CountAnaCreditCustomers > 0 Then
            ...
            Try
                ...
                'BgwBaisFilesCreation.ReportProgress(2, "Start creating AnaCredit BAIS File:ACCPIF_CCB.csv")
                'BgwBaisFilesCreation.ReportProgress(2, "Executing SQL Procedure:ANACREDIT_ACCPIF_Fill - AnaCredit Customers for  " & rd)
                'cmd.CommandText = "EXEC [ANACREDIT_ACCPIF_Fill] @RISKDATE='" & rdsql & "'"
                'cmd.ExecuteNonQuery()

                BgwBaisFilesCreation.ReportProgress(2, "Start creating AnaCredit BAIS File:ACCPAF_CCB.csv")
                cmd.CommandText = "SELECT [Status] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25') and [Id_SQL_Parameters] in ('BAIS')"
                ParameterStatus = cmd.ExecuteScalar
                If ParameterStatus = "Y" Then
                    Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACCPIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
                    da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                    dt = New System.Data.DataTable()
                    da.Fill(dt)
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        cmd.CommandText = SqlCommandText
                        If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                            BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.25/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                            cmd.ExecuteNonQuery()
                        End If
                    Next
                End If
                ...
                'New Code
                Dim CSV_HEADER As String = "ACCPAF_MDANT|ACCPAF_ARAID|ACCPAF_ACPTP|ACCPAF_ACPID|ACCPAF_KDREA|ACCPAF_FILNR|ACCPAF_DUBID|ACCPAF_DUBST|ACCPAF_KZINT|ACCPAF_LENID|ACCPAF_LENST|ACCPAF_ANATP|ACCPAF_ANATS|ACCPAF_ANAID|ACCPAF_ANAST|ACCPAF_ANKTP|ACCPAF_ANKST|ACCPAF_ARIAD|ACCPAF_RIAST|ACCPAF_ACBLZ|ACCPAF_BLZST|ACCPAF_STEUN|ACCPAF_STEST|ACCPAF_KGBID|ACCPAF_KGBST|ACCPAF_KNMID|ACCPAF_KNMST|ACCPAF_ISINR|ACCPAF_ISIST|ACCPAF_BKBIC|ACCPAF_BICST|ACCPAF_ACBAK|ACCPAF_BAKST|ACCPAF_ACFVC|ACCPAF_FVCST|ACCPAF_ACIFS|ACCPAF_IFSST|ACCPAF_BCPTP|ACCPAF_BTPST|ACCPAF_BCPID|ACCPAF_BTPID|ACCPAF_CCPTP|ACCPAF_CTPST|ACCPAF_CCPID|ACCPAF_CIDST|ACCPAF_HOUTP|ACCPAF_HOTST|ACCPAF_HOUID|ACCPAF_HOUST|ACCPAF_IPUTP|ACCPAF_IPTST|ACCPAF_IPUID|ACCPAF_IPUST|ACCPAF_AUPTP|ACCPAF_AUTST|ACCPAF_AUPID|ACCPAF_AUPST|ACCPAF_KNAME|ACCPAF_KNAST|ACCPAF_STRAS|ACCPAF_STRST|ACCPAF_PLZOR|ACCPAF_PLZST|ACCPAF_KREIS|ACCPAF_KREST|ACCPAF_PLZNR|ACCPAF_PLNST|ACCPAF_LDISO|ACCPAF_LDIST|ACCPAF_ARECH|ACCPAF_RECST|ACCPAF_ATYOB|ACCPAF_ATYST|ACCPAF_AINSE|ACCPAF_AINST|ACCPAF_BRNCH|ACCPAF_NACST|ACCPAF_ASOLP|ACCPAF_ASOST|ACCPAF_DXOLP|ACCPAF_DXOST|ACCPAF_AENSI|ACCPAF_AENST|ACCPAF_DXNSI|ACCPAF_DXNST|ACCPAF_MITAR|ACCPAF_MITST|ACCPAF_BILSU|ACCPAF_BILST|ACCPAF_UMMIO|ACCPAF_UMMST|ACCPAF_BILAR|ACCPAF_BIAST|ACCPAF_RESE1|ACCPAF_RESE2|ACCPAF_RESE3|ACCPAF_FREI1|ACCPAF_FREI2|ACCPAF_FREI3|ACCPAF_FREI4|ACCPAF_FREI5|ACCPAF_LOEKZ|ACCPAF_IFNAM|ACCPAF_DXIFD"
                ...
                Dim ACCPIF_KZINT As String = Nothing
                ...
                Dim ACCPIF_ANKTP As String = Nothing
                Dim ACCPIF_ANKST As String = Nothing
                ...
                Dim ACCPIF_STEUN As String = Nothing
                Dim ACCPIF_STEST As String = Nothing
                ...
                Dim ACCPIF_BKBIC As String = Nothing
                Dim ACCPIF_BICST As String = Nothing
                ...
                Dim ACCPIF_BCPTP As String = Nothing
                Dim ACCPIF_BTPST As String = Nothing
                Dim ACCPIF_BCPID As String = Nothing
                Dim ACCPIF_BTPID As String = Nothing
                Dim ACCPIF_CCPTP As String = Nothing
                Dim ACCPIF_CTPST As String = Nothing
                Dim ACCPIF_CCPID As String = Nothing
                Dim ACCPIF_CIDST As String = Nothing
                ...
                Dim ACCPIF_ATYOB As String = Nothing
                Dim ACCPIF_ATYST As String = Nothing
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    ACCPIF_KZINT = dt.Rows.Item(i).Item("ACCPIF_KZINT") & "|"
                    ...
                    ACCPIF_ANKTP = dt.Rows.Item(i).Item("ACCPIF_ANKTP") & "|"
                    ACCPIF_ANKST = dt.Rows.Item(i).Item("ACCPIF_ANKST") & "|"
                    ...
                    ACCPIF_STEUN = dt.Rows.Item(i).Item("ACCPIF_STEUN") & "|"
                    ACCPIF_STEST = dt.Rows.Item(i).Item("ACCPIF_STEST") & "|"
                    ...
                    ACCPIF_BKBIC = dt.Rows.Item(i).Item("ACCPIF_BKBIC") & "|"
                    ACCPIF_BICST = dt.Rows.Item(i).Item("ACCPIF_BICST") & "|"
                    ...
                    ACCPIF_BCPTP = dt.Rows.Item(i).Item("ACCPIF_BCPTP") & "|"
                    ACCPIF_BTPST = dt.Rows.Item(i).Item("ACCPIF_BTPST") & "|"
                    ACCPIF_BCPID = dt.Rows.Item(i).Item("ACCPIF_BCPID") & "|"
                    ACCPIF_BTPID = dt.Rows.Item(i).Item("ACCPIF_BTPID") & "|"
                    ACCPIF_CCPTP = dt.Rows.Item(i).Item("ACCPIF_CCPTP") & "|"
                    ACCPIF_CTPST = dt.Rows.Item(i).Item("ACCPIF_CTPST") & "|"
                    ACCPIF_CCPID = dt.Rows.Item(i).Item("ACCPIF_CCPID") & "|"
                    ACCPIF_CIDST = dt.Rows.Item(i).Item("ACCPIF_CIDST") & "|"
                    ...
                    ACCPIF_ATYOB = dt.Rows.Item(i).Item("ACCPIF_ATYOB") & "|"
                    ACCPIF_ATYST = dt.Rows.Item(i).Item("ACCPIF_ATYST") & "|"
                    ...
                    CSV_ROW = ACCPIF_MDANT & ACCPIF_ARAID & ACCPIF_ACPTP & ACCPIF_ACPID & ACCPIF_KDNMD & ACCPIF_FILNR & ACCPIF_DUBID & ACCPIF_DUBST & ACCPIF_KZINT & ACCPIF_LENID & ACCPIF_LENST & ACCPIF_ANATP & ACCPIF_ANATS & ACCPIF_ANAID & ACCPIF_ANAST & ACCPIF_ANKTP & ACCPIF_ANKST & ACCPIF_ARIAD & ACCPIF_RIAST & ACCPIF_ACBLZ & ACCPIF_BLZST & ACCPIF_STEUN & ACCPIF_STEST & ACCPIF_KGBID & ACCPIF_KGBST & ACCPIF_KNMID & ACCPIF_KNMST & ACCPIF_ISINR & ACCPIF_ISIST & ACCPIF_BKBIC & ACCPIF_BICST & ACCPIF_ACBAK & ACCPIF_BAKST & ACCPIF_ACFVC & ACCPIF_FVCST & ACCPIF_ACIFS & ACCPIF_IFSST & ACCPIF_BCPTP & ACCPIF_BTPST & ACCPIF_BCPID & ACCPIF_BTPID & ACCPIF_CCPTP & ACCPIF_CTPST & ACCPIF_CCPID & ACCPIF_CIDST & ACCPIF_HOUTP & ACCPIF_HOTST & ACCPIF_HOUID & ACCPIF_HOUST & ACCPIF_IPUTP & ACCPIF_IPTST & ACCPIF_IPUID & ACCPIF_IPUST & ACCPIF_AUPTP & ACCPIF_AUTST & ACCPIF_AUPID & ACCPIF_AUPST & ACCPIF_KNAME & ACCPIF_KNAST & ACCPIF_STRAS & ACCPIF_STRST & ACCPIF_PLZOR & ACCPIF_PLZST & ACCPIF_KREIS & ACCPIF_KREST & ACCPIF_PLZNR & ACCPIF_PLNST & ACCPIF_LDISO & ACCPIF_LDIST & ACCPIF_ARECH & ACCPIF_RECST & ACCPIF_ATYOB & ACCPIF_ATYST & ACCPIF_AINSE & ACCPIF_AINST & ACCPIF_BRNCH & ACCPIF_NACST & ACCPIF_ASOLP & ACCPIF_ASOST & ACCPIF_DXOLP & ACCPIF_DXOST & ACCPIF_AENSI & ACCPIF_AENST & ACCPIF_DXNSI & ACCPIF_DXNST & ACCPIF_MITAR & ACCPIF_MITST & ACCPIF_BILSU & ACCPIF_BILST & ACCPIF_UMMIO & ACCPIF_UMMST & ACCPIF_BILAR & ACCPIF_BIAST & ACCPIF_RESE1 & ACCPIF_RESE2 & ACCPIF_RESE3 & ACCPIF_FREI1 & ACCPIF_FREI2 & ACCPIF_FREI3 & ACCPIF_FREI4 & ACCPIF_FREI5 & ACCPIF_LOEKZ & ACCPIF_IFNAM & ACCPIF_DXIFD
    ...
    Private Sub ACFDIF_CREATION()
        ...
        Try
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACFDIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
            ...
            Dim CSV_HEADER As String = "ACFDAF_MDANT|ACFDAF_ARAID|ACFDAF_AOAID|ACFDAF_ACTID|ACFDAF_AINID|ACFDAF_MODUL|ACFDAF_KDREA|ACFDAF_KTONR|ACFDAF_GSREF|ACFDAF_WPKNR|ACFDAF_DEPNR|ACFDAF_HAWHG|ACFDAF_FILNR|ACFDAF_KZICL|ACFDAF_ATYOI|ACFDAF_ATYST|ACFDAF_AAMTY|ACFDAF_AAMST|ACFDAF_WHISO|ACFDAF_WHIST|ACFDAF_AFIIN|ACFDAF_AFIST|ACFDAF_DXVBE|ACFDAF_DXVST|ACFDAF_DXIOP|ACFDAF_DXIST|ACFDAF_AINRC|ACFDAF_AINST|ACFDAF_AINRF|ACFDAF_AIRST|ACFDAF_AIRRF|ACFDAF_ARRST|ACFDAF_AIRSM|ACFDAF_AIMST|ACFDAF_AINRT|ACFDAF_AISST|ACFDAF_DXMAT|ACFDAF_DXMST|ACFDAF_ATCAI|ACFDAF_ATCST|ACFDAF_APAFR|ACFDAF_APAST|ACFDAF_APRLL|ACFDAF_APRST|ACFDAF_APURP|ACFDAF_APUST|ACFDAF_ARECC|ACFDAF_AREST|ACFDAF_AZIRE|ACFDAF_AZIST|ACFDAF_DXSET|ACFDAF_DXSST|ACFDAF_ASUDE|ACFDAF_ASUST|ACFDAF_SCOID|ACFDAF_SCOST|ACFDAF_ARERI|ACFDAF_ARIST|ACFDAF_ABFVC|ACFDAF_ABFST|ACFDAF_AINRA|ACFDAF_ANRST|ACFDAF_DXNIR|ACFDAF_DXNST|ACFDAF_ADFST|ACFDAF_AFSST|ACFDAF_DXFST|ACFDAF_DFSST|ACFDAF_ATRAM|ACFDAF_ATRST|ACFDAF_AARIN|ACFDAF_AARST|ACFDAF_DXPDI|ACFDAF_DXPST|ACFDAF_ATYOS|ACFDAF_ATOST|ACFDAF_AOUNA|ACFDAF_AOUST|ACFDAF_AACIN|ACFDAF_AACST|ACFDAF_AOBSA|ACFDAF_AOBST|ACFDAF_RESE1|ACFDAF_RESE2|ACFDAF_RESE3|ACFDAF_FREI1|ACFDAF_FREI2|ACFDAF_FREI3|ACFDAF_FREI4|ACFDAF_FREI5|ACFDAF_LOEKZ|ACFDAF_IFNAM|ACFDAF_DXIFD"
            Dim CSV_ROW As String = Nothing
            ...
            If Count > 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACFDIF_MDANT & ACFDIF_ARAID & ACFDIF_AOAID & ACFDIF_ACTID & ACFDIF_AINID & ACFDIF_MODUL & ACFDIF_KDNRH & ACFDIF_KTONR & ACFDIF_GSREF & ACFDIF_WPKNR & ACFDIF_DEPNR & ACFDIF_HAWHG & ACFDIF_FILNR & ACFDIF_KZICL & ACFDIF_ATYOI & ACFDIF_ATYST & ACFDIF_AAMTY & ACFDIF_AAMST & ACFDIF_WHISO & ACFDIF_WHIST & ACFDIF_AFIIN & ACFDIF_AFIST & ACFDIF_DXVBE & ACFDIF_DXVST & ACFDIF_DXIOP & ACFDIF_DXIST & ACFDIF_AINRC & ACFDIF_AINST & ACFDIF_AINRF & ACFDIF_AIRST & ACFDIF_AIRRF & ACFDIF_ARRST & ACFDIF_AIRSM & ACFDIF_AIMST & ACFDIF_AINRT & ACFDIF_AISST & ACFDIF_DXMAT & ACFDIF_DXMST & ACFDIF_ATCAI & ACFDIF_ATCST & ACFDIF_APAFR & ACFDIF_APAST & ACFDIF_APRLL & ACFDIF_APRST & ACFDIF_APURP & ACFDIF_APUST & ACFDIF_ARECC & ACFDIF_AREST & ACFDIF_AZIRE & ACFDIF_AZIST & ACFDIF_DXSET & ACFDIF_DXSST & ACFDIF_ASUDE & ACFDIF_ASUST & ACFDIF_SCOID & ACFDIF_SCOST & ACFDIF_ARERI & ACFDIF_ARIST & ACFDIF_ABFVC & ACFDIF_ABFST & ACFDIF_AINRA & ACFDIF_ANRST & ACFDIF_DXNIR & ACFDIF_DXNST & ACFDIF_ADFST & ACFDIF_AFSST & ACFDIF_DXFST & ACFDIF_DFSST & ACFDIF_ATRAM & ACFDIF_ATRST & ACFDIF_AARIN & ACFDIF_AARST & ACFDIF_DXPDI & ACFDIF_DXPST & ACFDIF_ATYOS & ACFDIF_ATOST & ACFDIF_AOUNA & ACFDIF_AOUST & ACFDIF_AACIN & ACFDIF_AACST & ACFDIF_AOBSA & ACFDIF_AOBST & ACFDIF_RESE1 & ACFDIF_RESE2 & ACFDIF_RESE3 & ACFDIF_FREI1 & ACFDIF_FREI2 & ACFDIF_FREI3 & ACFDIF_FREI4 & ACFDIF_FREI5 & ACFDIF_LOEKZ & ACFDIF_IFNAM & ACFDIF_DXIFD
    ...
    Private Sub ACFAIF_CREATION()
        ...
        Try
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACFAIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
            ...
            Dim CSV_HEADER As String = "ACFAAF_MDANT|ACFAAF_ARAID|ACFAAF_AOAID|ACFAAF_ACTID|ACFAAF_AINID|ACFAAF_MODUL|ACFAAF_KDREA|ACFAAF_KTONR|ACFAAF_GSREF|ACFAAF_WPKNR|ACFAAF_DEPNR|ACFAAF_HAWHG|ACFAAF_FILNR|ACFAAF_AACOF|ACFAAF_AAOST|ACFAAF_ABASR|ACFAAF_ABAST|ACFAAF_AACWO|ACFAAF_AAWST|ACFAAF_AACIA|ACFAAF_AAIST|ACFAAF_ATYIM|ACFAAF_ATIST|ACFAAF_AIMAM|ACFAAF_AIAST|ACFAAF_ASOOE|ACFAAF_ASOST|ACFAAF_AAFVC|ACFAAF_AAFST|ACFAAF_APSIN|ACFAAF_APSST|ACFAAF_DXPSI|ACFAAF_XPSST|ACFAAF_APAOF|ACFAAF_APOST|ACFAAF_ASOFR|ACFAAF_ASFST|ACFAAF_DXSFR|ACFAAF_DXOST|ACFAAF_ACRSD|ACFAAF_ACRST|ACFAAF_HBKZN|ACFAAF_HBKST|ACFAAF_ACAAM|ACFAAF_ACAST|ACFAAF_RESE1|ACFAAF_RESE2|ACFAAF_RESE3|ACFAAF_FREI1|ACFAAF_FREI2|ACFAAF_FREI3|ACFAAF_FREI4|ACFAAF_FREI5|ACFAAF_LOEKZ|ACFAAF_IFNAM|ACFAAF_DXIFD"
            Dim CSV_ROW As String = Nothing
            ...
            If Count <> 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACFAIF_MDANT & ACFAIF_ARAID & ACFAIF_AOAID & ACFAIF_ACTID & ACFAIF_AINID & ACFAIF_MODUL & ACFAIF_KDNRH & ACFAIF_KTONR & ACFAIF_GSREF & ACFAIF_WPKNR & ACFAIF_DEPNR & ACFAIF_HAWHG & ACFAIF_FILNR & ACFAIF_AACOF & ACFAIF_AAOST & ACFAIF_ABASR & ACFAIF_ABAST & ACFAIF_AACWO & ACFAIF_AAWST & ACFAIF_AACIA & ACFAIF_AAIST & ACFAIF_ATYIM & ACFAIF_ATIST & ACFAIF_AIMAM & ACFAIF_AIAST & ACFAIF_ASOOE & ACFAIF_ASOST & ACFAIF_AAFVC & ACFAIF_AAFST & ACFAIF_APSIN & ACFAIF_APSST & ACFAIF_DXPSI & ACFAIF_XPSST & ACFAIF_APAOF & ACFAIF_APOST & ACFAIF_ASOFR & ACFAIF_ASFST & ACFAIF_DXSFR & ACFAIF_DXOST & ACFAIF_ACRSD & ACFAIF_ACRST & ACFAIF_HBKZN & ACFAIF_HBKST & ACFAIF_ACAAM & ACFAIF_ACAST & ACFAIF_RESE1 & ACFAIF_RESE2 & ACFAIF_RESE3 & ACFAIF_FREI1 & ACFAIF_FREI2 & ACFAIF_FREI3 & ACFAIF_FREI4 & ACFAIF_FREI5 & ACFAIF_LOEKZ & ACFAIF_IFNAM & ACFAIF_DXIFD
    ...
    Private Sub ACIPIF_CREATION()
        ...
        Try
            ...
            ParameterStatus = cmd.ExecuteScalar
            If ParameterStatus = "Y" Then
                Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACIPIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
                da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
                dt = New System.Data.DataTable()
                da.Fill(dt)
                For i = 0 To dt.Rows.Count - 1
            ...
            Dim CSV_HEADER As String = "ACIPIF_MDANT|ACIPIF_ARAID|ACIPIF_AOAID|ACIPIF_APRID|ACIPIF_GARFN|ACIPIF_ATYOP|ACIPIF_ATYST|ACIPIF_APRVA|ACIPIF_APRST|ACIPIF_ATOPV|ACIPIF_ATOST|ACIPIF_APVAP|ACIPIF_APVST|ACIPIF_LDISO|ACIPIF_LDIST|ACIPIF_KREIS|ACIPIF_KREST|ACIPIF_PLZNR|ACIPIF_PLNST|ACIPIF_DXPRV|ACIPIF_DXPST|ACIPIF_DXMAT|ACIPIF_DXMST|ACIPIF_APROV|ACIPIF_APOST|ACIPIF_DXPRO|ACIPIF_DXOST|ACIPIF_RESE1|ACIPIF_RESE2|ACIPIF_RESE3|ACIPIF_FREI1|ACIPIF_FREI2|ACIPIF_FREI3|ACIPIF_FREI4|ACIPIF_FREI5|ACIPIF_LOEKZ|ACIPIF_IFNAM|ACIPIF_DXIFD"
            Dim CSV_ROW As String = Nothing
            ...
            If Count <> 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACIPIF_MDANT & ACIPIF_ARAID & ACIPIF_AOAID & ACIPIF_APRID & ACIPIF_GARFN & ACIPIF_ATYOP & ACIPIF_ATYST & ACIPIF_APRVA & ACIPIF_APRST & ACIPIF_ATOPV & ACIPIF_ATOST & ACIPIF_APVAP & ACIPIF_APVST & ACIPIF_LDISO & ACIPIF_LDIST & ACIPIF_KREIS & ACIPIF_KREST & ACIPIF_PLZNR & ACIPIF_PLNST & ACIPIF_DXPRV & ACIPIF_DXPST & ACIPIF_DXMAT & ACIPIF_DXMST & ACIPIF_APROV & ACIPIF_APOST & ACIPIF_DXPRO & ACIPIF_DXOST & ACIPIF_RESE1 & ACIPIF_RESE2 & ACIPIF_RESE3 & ACIPIF_FREI1 & ACIPIF_FREI2 & ACIPIF_FREI3 & ACIPIF_FREI4 & ACIPIF_FREI5 & ACIPIF_LOEKZ & ACIPIF_IFNAM & ACIPIF_DXIFD
    ...
    Private Sub ACCFIF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACCFIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
        ...
        Dim CSV_HEADER As String = "ACCFIF_MDANT|ACCFIF_ARAID|ACCFIF_AOAID|ACCFIF_ACPTP|ACCFIF_ACPID|ACCFIF_ACTID|ACCFIF_AINID|ACCFIF_ACPRO|ACCFIF_JLIAM|ACCFIF_JLIST|ACCFIF_FREI1|ACCFIF_FREI2|ACCFIF_FREI3|ACCFIF_FREI4|ACCFIF_FREI5|ACCFIF_LOEKZ|ACCFIF_IFNAM|ACCFIF_DXIFD"
        Dim CSV_ROW As String = Nothing
        ...
        If Count <> 0 Then
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACCFIF_MDANT & ACCFIF_ARAID & ACCFIF_AOAID & ACCFIF_ACPTP & ACCFIF_ACPID & ACCFIF_ACTID & ACCFIF_AINID & ACCFIF_ACPRO & ACCFIF_JLIAM & ACCFIF_JLIST & ACCFIF_FREI1 & ACCFIF_FREI2 & ACCFIF_FREI3 & ACCFIF_FREI4 & ACCFIF_FREI5 & ACCFIF_LOEKZ & ACCFIF_IFNAM & ACCFIF_DXIFD
    ...
    Private Sub ACIFIF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACIFIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
        ...
        'New Code
        Dim CSV_HEADER As String = "ACIFIF_MDANT|ACIFIF_ARAID|ACIFIF_AOAID|ACIFIF_APRID|ACIFIF_ACTID|ACIFIF_AINID|ACIFIF_APAVA|ACIFIF_APAST|ACIFIF_ASCPS|ACIFIF_ASCST|ACIFIF_FREI1|ACIFIF_FREI2|ACIFIF_FREI3|ACIFIF_FREI4|ACIFIF_FREI5|ACIFIF_LOEKZ|ACIFIF_IFNAM|ACIFIF_DXIFD"
        Dim CSV_ROW As String = Nothing
        ...
        If Count <> 0 Then
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACIFIF_MDANT & ACIFIF_ARAID & ACIFIF_AOAID & ACIFIF_APRID & ACIFIF_ACTID & ACIFIF_AINID & ACIFIF_APAVA & ACIFIF_APAST & ACIFIF_ASCPS & ACIFIF_ASCST & ACIFIF_FREI1 & ACIFIF_FREI2 & ACIFIF_FREI3 & ACIFIF_FREI4 & ACIFIF_FREI5 & ACIFIF_LOEKZ & ACIFIF_IFNAM & ACIFIF_DXIFD
    ...
    Private Sub ACPCIF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACPCIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
        ...
        'New Code
        Dim CSV_HEADER As String = "ACPCIF_MDANT|ACPCIF_ARAID|ACPCIF_AOAID|ACPCIF_APPTP|ACPCIF_APPID|ACPCIF_APRID|ACPCIF_FREI1|ACPCIF_FREI2|ACPCIF_FREI3|ACPCIF_FREI4|ACPCIF_FREI5|ACPCIF_LOEKZ|ACPCIF_IFNAM|ACPCIF_DXIFD"
        Dim CSV_ROW As String = Nothing
        ...
        If Count <> 0 Then
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACPCIF_MDANT & ACPCIF_ARAID & ACPCIF_AOAID & ACPCIF_APPTP & ACPCIF_APPID & ACPCIF_APRID & ACPCIF_FREI1 & ACPCIF_FREI2 & ACPCIF_FREI3 & ACPCIF_FREI4 & ACPCIF_FREI5 & ACPCIF_LOEKZ & ACPCIF_IFNAM & ACPCIF_DXIFD
    ...
    Private Sub ACPDIF_CREATION()
        ...
        ParameterStatus = cmd.ExecuteScalar
        If ParameterStatus = "Y" Then
            Me.QueryText = "Select * from [SQL_PARAMETER_DETAILS_SECOND] where  [SQL_Name_1] in ('BAIS_ACPDIF') and [Status] in ('Y') and [Id_SQL_Parameters_Details] in (SELECT [ID] FROM [SQL_PARAMETER_DETAILS] where  [SQL_Name_1] in ('BAIS_ANACREDIT_FILES_V1.25'))"
            da = New SqlDataAdapter(Me.QueryText.Trim(), conn)
            dt = New System.Data.DataTable()
            da.Fill(dt)
            For i = 0 To dt.Rows.Count - 1
        ...
        'New Code
        Dim CSV_HEADER As String = "ACPDIF_MDANT|ACPDIF_ARAID|ACPDIF_AOAID|ACPDIF_ACPTP|ACPDIF_ACPID|ACPDIF_PDPRZ|ACPDIF_PDPST|ACPDIF_ADFST|ACPDIF_AFSST|ACPDIF_DXFST|ACPDIF_DFSST|ACPDIF_FREI1|ACPDIF_FREI2|ACPDIF_FREI3|ACPDIF_FREI4|ACPDIF_FREI5|ACPDIF_LOEKZ|ACPDIF_IFNAM|ACPDIF_DXIFD"
        Dim CSV_ROW As String = Nothing
        ...
        If Count > 0 Then
            ...
            Try
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    CSV_ROW = ACPDIF_MDANT & ACPDIF_ARAID & ACPDIF_AOAID & ACPDIF_ACPTP & ACPDIF_ACPID & ACPDIF_PDPRZ & ACPDIF_PDPST & ACPDIF_ADFST & ACPDIF_AFSST & ACPDIF_DXFST & ACPDIF_DFSST & ACPDIF_FREI1 & ACPDIF_FREI2 & ACPDIF_FREI3 & ACPDIF_FREI4 & ACPDIF_FREI5 & ACPDIF_LOEKZ & ACPDIF_IFNAM & ACPDIF_DXIFD
