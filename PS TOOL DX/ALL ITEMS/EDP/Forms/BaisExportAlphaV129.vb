...
Public Class BaisExportAlphaV129
    ...
    Private Sub BaisExportAlphaV129_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAlphaV129_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_v1.29_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_v1.29_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
            ...
            If Count = 0 Then
                Try
                    ...
                    If ParameterStatus = "Y" Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                                BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_COMMON_INTERFACE_FILES_V1.29/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                                cmd.ExecuteNonQuery()
                            End If
                        Next
                    End If
                    ...
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        CSV_ROW = DVTIFF_MDANT & DVTIFF_GSREF & DVTIFF_FILNR & DVTIFF_KDREA & DVTIFF_DXABD & DVTIFF_GSKLA & DVTIFF_SUKLA & DVTIFF_DVART & DVTIFF_DXVAL & DVTIFF_DANWC & DVTIFF_DANBT & DVTIFF_DVKWC & DVTIFF_DVKBT & DVTIFF_HBKZN & DVTIFF_ZWRIS & DVTIFF_KBTRG & DVTIFF_PTEIN & DVTIFF_WHGKP & DVTIFF_BCHSW & DVTIFF_BWVNS & DVTIFF_WHGBU & DVTIFF_URDEA & DVTIFF_NETKR & DVTIFF_KZCVA & DVTIFF_GSARE & DVTIFF_FAIRV & DVTIFF_WHGFV & DVTIFF_DXVKT & DVTIFF_HFZGP & DVTIFF_AFREF & DVTIFF_POOLI & DVTIFF_AEIDF & DVTIFF_BESVB & DVTIFF_RESE1 & DVTIFF_RESE2 & DVTIFF_FREI1 & DVTIFF_FREI2 & DVTIFF_FREI3 & DVTIFF_LOEKZ & DVTIFF_IFNAM & DVTIFF_DXIFD
