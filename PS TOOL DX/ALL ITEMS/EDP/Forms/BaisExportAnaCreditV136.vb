...
'Description:
'Modify log:  
'    1. Add by Papas; Time:24.05.2023; Content: BAIS system version is updated to Version 1.36. Add the BaisExportAnaCreditV134 class for Bais Version 1.36

'******************************************

Public Class BaisExportAnaCreditV136
    ...
    Private Sub BaisExportAnaCreditV136_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BaisExportAnaCreditV136_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#End Region
        ...
        Try
            Using zip As ZipFile = New ZipFile
                For Each File In Directory.GetFiles(BaisFilesCreationPath, "*.CSV", SearchOption.TopDirectoryOnly)
                    zip.AddFile(File, "")
                Next
                zip.Save(BaisFilesCreationPath & "BAIS_Files_ALPHA_AnaCredit_v1.36_from_PSTOOL_" & rdsql & ".rar")
                Dim BaisFilesList As String() = Directory.GetFiles(BaisFilesCreationPath, "*.CSV")
                For Each f In BaisFilesList
                    File.Delete(f)
                Next
            End Using
            Me.BaisExportEvents_RichTextBox.Text = Me.BaisExportEvents_RichTextBox.Text & vbNewLine & "File(s) zipped in " & "BAIS_Files_ALPHA_AnaCredit_v1.36_from_PSTOOL_" & rdsql & ".rar"
        Catch ex As Exception
    ...
    Private Sub ACCPIF_CREATION()
        ...
        Dim ACCPIF_MITAE As String = Nothing 'New 1.36
        Dim ACCPIF_MIEST As String = Nothing 'New 1.36
        Dim ACCPIF_BILSE As String = Nothing 'New 1.36
        Dim ACCPIF_BIEST As String = Nothing 'New 1.36
        Dim ACCPIF_UMMIE As String = Nothing 'New 1.36
        Dim ACCPIF_UMEST As String = Nothing 'New 1.36
            ...
            Try
                ...
                If ParameterStatus = "Y" Then
                    ...
                    For i = 0 To dt.Rows.Count - 1
                        ...
                        cmd.CommandText = SqlCommandText
                        If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                            BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACCPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                            cmd.ExecuteNonQuery()
                        End If
                    Next
                End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACFDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACFAIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
        ...
        Try
            ...
            If ParameterStatus = "Y" Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    cmd.CommandText = SqlCommandText
                    If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                        BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACIPIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                        cmd.ExecuteNonQuery()
                    End If
                Next
            End If
    ...
    Private Sub ACCFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACCFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACIFIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACIFIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPCIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACPCIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub ACPDIF_CREATION()
        ...
        If ParameterStatus = "Y" Then
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                cmd.CommandText = SqlCommandText
                If dt.Rows.Item(i).Item("SQL_Name_1") <> "" Then
                    BgwBaisFilesCreation.ReportProgress(2, "Execute SQL Commands in BAIS_ANACREDIT_FILES_V1.36/ACPDIF/" & dt.Rows.Item(i).Item("SQL_Name_1"))
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
