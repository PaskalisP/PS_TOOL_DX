        ...
        If LiquidityReserveUserFind <> "" Then
            Try
                If IsDate(Me.BestandDateEdit.Text) = True Then
                    ...
                    Else
                        'Bestand Date exists
                        If MessageBox.Show("The Bestand Date is present in the current Table" & vbNewLine & "Should the Securities Bestand be re-created for the given Date?", "BESTAND DATE PRESENT", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                            'Alte Daten löschen
