...
Partial Public Class AllContractsAccountsDataSet
    ...
    Partial Public Class ALL_CONTRACTS_ACCOUNTSDataTable
        ...
        Public Overloads Function AddALL_CONTRACTS_ACCOUNTSRow( _
                    ...
                    ByVal JointLiabilityAmount As Double) As ALL_CONTRACTS_ACCOUNTSRow
    ...
    Partial Public Class ALL_CONTRACTS_ACCOUNTSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [ALL_CONTRACTS_ACCOUNTS] ([Contract_Account], [ClientNr], [ClientName"& _ 
                ...
                "oleDescription], [JointLiabilityAmount]) VALUES (@Contract_Account, @ClientNr, @"& _ 
                "ClientName, @ContractType, @ProductType, @StartDate, @MaturityDate, @BusinessTyp"& _ 
                "e, @KEV_Collateral, @Valid, @AnaCredit_Valid, @IsAnaCredit, @CCY, @GSTIFF_Refere"& _ 
                "nce, @CCB_Group, @InputDate, @TypeOfInstrument, @TypeOfInstrumentDescription, @A"& _ 
                "mortisationType, @AmortisationTypeDescription, @FiduciaryInstrument, @FiduciaryI"& _ 
                "nstrumentDescription, @InterestRate, @Spread, @InterestRateType, @InterestRateTy"& _ 
                "peDescription, @InterestRateCap, @InterestRateFloor, @InterestRateResetFrequency"& _ 
                ", @InterestRateResetFrequencyDescription, @CommitmentAmountInceptionOrig, @Excha"& _ 
                "ngeRate, @CommitmentAmountInceptionEUR, @PaymentFrequency, @PaymentFrequencyDesc"& _ 
                "ription, @ProjectFinanceLoan, @ProjectFinanceLoanDescription, @Purpose, @Purpose"& _ 
                "Description, @Recourse, @RecourseDescription, @ReferenceRate, @ReferenceRateDesc"& _ 
                "ription, @SettlementDate, @SyndicatedContractIdentifier, @RepaymentRights, @Repa"& _ 
                "ymentRightsDescription, @InterestRateAverage, @NextInterestRateDateReset, @Defau"& _ 
                "ltStatusInstrument, @DefaultStatusInstrumentDescription, @DateDefaultStatusInstr"& _ 
                "ument, @AmountPastDue, @DatePastDue, @TypeOfSecurisation, @TypeOfSecurisationDes"& _ 
                "cription, @OutstandingNominalAmount, @AccountingClassifInstruments, @AccountingC"& _ 
                "lassifInstrumentsDescription, @PerformingStatusInstrument, @PerformingStatusInst"& _ 
                "rumentDescription, @DatePerformingStatus, @StatusForbearance, @DateStatusForbear"& _ 
                "ance, @ComulativeRecoveryAmount, @StatusForbearance_Description, @Contract_Accou"& _ 
                "ntM, @ClientNrM, @ContractTypeDescription, @ProductTypeDescription, @Counterpart"& _ 
                "yRole, @CounterpartyRoleDescription, @JointLiabilityAmount)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [ALL_CONTRACTS_ACCOUNTS] SET [Contract_Account] = @Contract_Account, [Clie"& _ 
                ...
                "tLiabilityAmount] = @JointLiabilityAmount WHERE (([ID] = @Original_ID))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, Contract_Account, ClientNr, ClientName, ContractType, ProductTy"& _ 
                ...
                "terpartyRole, CounterpartyRoleDescription, JointLiabilityAmount"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM           "& _ 
                " ALL_CONTRACTS_ACCOUNTS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (ClientNr <> '0')"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY StartDate DESC"& _ 
                ""
            ...
            Me._commandCollection(1).CommandText = "SELECT AccountingClassifInstruments, AccountingClassifInstrumentsDescription, Amo"& _ 
                ...
                "mentDescription, ExchangeRate, FiduciaryInstrument, FiduciaryInstrumentDescripti"& _ 
                "on, GSTIFF_Reference, ID, InputDate, InterestRate, InterestRateAverage, Interest"& _ 
                "RateCap, InterestRateFloor, InterestRateResetFrequency, InterestRateResetFrequen"& _ 
                "cyDescription, InterestRateType, InterestRateTypeDescription, IsAnaCredit, Joint"& _ 
                "LiabilityAmount, KEV_Collateral, MaturityDate, NextInterestRateDateReset, Outsta"& _ 
                "ndingNominalAmount, PaymentFrequency, PaymentFrequencyDescription, PerformingSta"& _ 
                "tusInstrument, PerformingStatusInstrumentDescription, ProductType, ProductTypeDe"& _ 
                "scription, ProjectFinanceLoan, ProjectFinanceLoanDescription, Purpose, PurposeDe"& _ 
                "scription, Recourse, RecourseDescription, ReferenceRate, ReferenceRateDescriptio"& _ 
                "n, RepaymentRights, RepaymentRightsDescription, SettlementDate, Spread, StartDat"& _ 
                "e, StatusForbearance, StatusForbearance_Description, SyndicatedContractIdentifie"& _ 
                "r, TypeOfInstrument, TypeOfInstrumentDescription, TypeOfSecurisation, TypeOfSecu"& _ 
                "risationDescription, Valid FROM ALL_CONTRACTS_ACCOUNTS WHERE (Contract_Account ="& _ 
                " @Param1)"
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal CounterpartyRole As String,  _
                    ByVal CounterpartyRoleDescription As String,  _
                    ByVal JointLiabilityAmount As Global.System.Nullable(Of Double)) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(73).Value = CType(Original_ID,Integer)
