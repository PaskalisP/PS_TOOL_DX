...
Public Class GL_Accounts
    ...
    Private Sub GL_Accounts_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.GL_ACCOUNTS_BAISTableAdapter.Fill(Me.PSTOOLDataset.GL_ACCOUNTS_BAIS)
    ...
    Private Sub PrintableComponentLink6_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink6.CreateMarginalHeaderArea
        Dim reportfooter As String = "BAIS GENERAL LEDGER ACCOUNTS"
        e.Graph.DrawString(reportfooter, New RectangleF(0, 0, e.Graph.ClientPageSize.Width, 20))
    End Sub
    ...
    Private Sub TabbedControlGroup1_SelectedPageChanged(sender As Object, e As DevExpress.XtraLayout.LayoutTabPageChangedEventArgs) Handles TabbedControlGroup1.SelectedPageChanged
        ...
        ElseIf Me.TabbedControlGroup1.SelectedTabPage.Text = "GL ITEMS (Profit/Loss Sheet)" Then
            PrintGrid = 3
        ElseIf Me.TabbedControlGroup1.SelectedTabPage.Text = "GL ACCOUNTS (BAIS)" Then
            PrintGrid = 5
        End If
    End Sub
    ...
    Private Sub BAIS_GL_Accounts_GridView_RowStyle(sender As Object, e As RowStyleEventArgs) Handles BAIS_GL_Accounts_GridView.RowStyle
        'Set Backcolor to Filter row
        If e.RowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            e.Appearance.BackColor = SystemColors.InactiveCaptionText
    ...
    Private Sub BAIS_GL_Accounts_GridView_ShownEditor(sender As Object, e As EventArgs) Handles BAIS_GL_Accounts_GridView.ShownEditor
        Dim view As GridView = CType(sender, GridView)
        If view.FocusedRowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            view.ActiveEditor.Properties.Appearance.BackColor = Color.Yellow
            view.ActiveEditor.Properties.Appearance.ForeColor = Color.Black
