    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If Me.GridControl2.FocusedView.Name = "ContractTypesBaseView" Then
                ...
                If XtraMessageBox.Show("Should the Contract Type: " & ContractTypeValue & " be deleted?", "DELETE CONTRACT TYPE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
