...
Public Class DailyBalanceSheetsDetails
    ...
    Private Sub TrialBalanceBaseNewView_RowStyle(sender As Object, e As RowStyleEventArgs) Handles TrialBalanceBaseNewView.RowStyle
        If e.RowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            e.Appearance.BackColor = SystemColors.InactiveCaptionText
        End If
    End Sub

    Private Sub TrialBalanceBaseNewView_ShownEditor(sender As Object, e As EventArgs) Handles TrialBalanceBaseNewView.ShownEditor
        Dim view As GridView = CType(sender, GridView)
        If view.FocusedRowHandle = DevExpress.XtraGrid.GridControl.AutoFilterRowHandle Then
            view.ActiveEditor.Properties.Appearance.ForeColor = Color.Yellow
        End If
            ...
            Try
                ...
                If dt1.Rows.Count > 0 Then
                    If d < DateSerial(2017, 12, 8) Then
                        ...
                        Me.GridControl4.MainView = TrialBalanceBaseView
                    ElseIf d >= DateSerial(2017, 12, 8) Then
                        SqlCommandText = dt1.Rows.Item(0).Item("SQL_Command_2").ToString.Replace("<RiskDate>", dsql)
                        Me.GridControl4.MainView = TrialBalanceBaseNewView
                    End If
