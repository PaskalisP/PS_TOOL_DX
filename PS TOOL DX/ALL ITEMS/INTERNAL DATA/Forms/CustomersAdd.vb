...
Public Class CustomersAdd
    ...
    Private Sub CustomerType_ImageComboBoxEdit_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CustomerType_ImageComboBoxEdit.SelectedIndexChanged
        CustomerType = Me.CustomerType_ImageComboBoxEdit.EditValue.ToString
    End Sub
End Class