    ...
    Private Sub GridControl2_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            ...
            If Me.GridControl2.FocusedView.Name = "IndustrialValuesBaseView" Then
                ...
                If MessageBox.Show("Should the Industry Value: " & IndustrialValue & " be deleted?", "DELETE CONTRACT TYPE", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
