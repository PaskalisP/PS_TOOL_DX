...
#Region "DOCUMENT TREELIST"
        ...
        If Me.TreeList1.FocusedNode.GetDisplayText(2).ToString = "File" Then
            ...
            Else
                If File.Exists(destPath) Then
                    If MessageBox.Show("The current file exists allready in the destination Folder!" & vbNewLine & vbNewLine & "Should the file be replaced in the destination Folder?", "FILE EXISTS", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub bbDelete_ItemClick(ByVal sender As Object, ByVal e As EventArgs)
        If Me.TreeList1.FocusedNode.GetDisplayText(2).ToString = "File" Then
            ...
            If MessageBox.Show("Should the File: " & FileFromNameInfo & " be deleted from the Client Documents ?", "CLIENT FILE DELETION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub Shareholder_GridControl_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If MessageBox.Show("Should the Shareholder: " & ShareholderName & " be deleted?", "DELETE SHAREHOLDER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub GeneralManager_GridControl_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If MessageBox.Show("Should the General Manager: " & GeneralManagerName & " be deleted?", "DELETE GENERAL MANAGER", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub ClientsContactPersons_GridControl_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If MessageBox.Show("Should the Contact: " & ContactName & " be deleted?", "DELETE CONTACT", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub ClientsContactsNotes_GridControl_EmbeddedNavigator_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.NavigatorButtonClickEventArgs)
        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If MessageBox.Show("Should the Contact Note ID: " & ContactNode_ID & " be deleted?", "DELETE CONTACT NOTES", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
