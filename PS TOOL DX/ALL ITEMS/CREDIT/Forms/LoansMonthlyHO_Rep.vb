...
Public Class LoansMonthlyHO_Rep
    ...
    Private Sub LiqV_Details_Load(sender As Object, e As EventArgs) Handles Me.Load
        conn.ConnectionString = My.Settings.PS_TOOL_DX_SQL_Client_ConnectionString
        cmd.Connection = conn

        Me.LiqV_Date_Comboedit.Properties.Items.Clear()
        Me.QueryText = "Select CONVERT(VARCHAR(10),[RepDate],104) as 'RLDC Date' from [CL_DRAWDOWN_OUTSTANDING] GROUP BY [RepDate] ORDER BY [RepDate] desc"
    ...
    Private Sub Load_LiqV_Details_btn_Click(sender As Object, e As EventArgs) Handles Load_LiqV_Details_btn.Click
        If Me.LiqV_Date_Comboedit.Text <> "" Then
            ...
            Try
                ...
                SplashScreenManager.Default.SetWaitFormCaption("Load data for the report" & vbNewLine & "(Stored Procedure:CREDIT_DEPT_MONTHLY_QUERY) for Business Date: " & rd)

                Me.QueryText = "Select * from SQL_PARAMETER_DETAILS where Id_SQL_Parameters in ('SEVERAL SELECTIONS') and SQL_Name_1 in ('CREDIT_DEPT_MONTHLY_QUERY') and Status in ('Y')"
                ...
                If dt1.Rows.Count > 0 Then
                    ...
                    Else
                        SplashScreenManager.CloseForm(False)
                        MessageBox.Show("There are no Data in Table:CL_DRAWDOWN_OUTSTANDING for the Report creation", "NO DATA", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                        Exit Sub
                    End If
                Else
                    SplashScreenManager.CloseForm(False)
                    MessageBox.Show("The SQL Command:SQL PROCEDURES PAREMETER/SEVERAL SELECTIONS/CREDIT_DEPT_MONTHLY_QUERY is either deactivated or not present!", "NO SQL COMMAND", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
                    Exit Sub
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "Loans Report to Head Office" & "   " & "Business Date: " & rd
