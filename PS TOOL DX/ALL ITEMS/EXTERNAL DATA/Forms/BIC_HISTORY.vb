...
Public Class BIC_HISTORY
    ...
    Private Sub BIC_HISTORY_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Get Last Update
        cmd.CommandText = "SELECT [LastImportTime] from [MANUAL IMPORTS] where [ProcName]='BIC PLUS DIRECTORY'"
        cmd.Connection.Open()
...
#End Region
    ...
    Private Sub Search_btn_Click(sender As Object, e As EventArgs) Handles Search_btn.Click
        If Me.SearchText_TextEdit.Text <> "" Then
            ...
            SplashScreenManager.Default.SetWaitFormCaption("Start searching History for BIC: " & Me.SearchText_TextEdit.Text)
    ...
    Private Sub PrintableComponentLink1_CreateMarginalHeaderArea(sender As Object, e As CreateAreaEventArgs) Handles PrintableComponentLink1.CreateMarginalHeaderArea
        Dim reportfooter As String = "BIC HISTORY for BIC Code:" & Me.SearchText_TextEdit.Text & "  " & "Printed on: " & Now
