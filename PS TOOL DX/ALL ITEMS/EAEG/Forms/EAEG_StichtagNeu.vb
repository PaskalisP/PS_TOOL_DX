...
Public Class EAEG_StichtagNeu
    ...
    Private Sub EAEG_StichtagNeu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.QueryText = "Select CONVERT(VARCHAR(10),[RLDC Date],104) as 'RLDC Date' from [RISK LIMIT DAILY CONTROL] where [RLDC Date]>='20171208' and [PL Result] is not NULL ORDER BY [ID] desc"
