    ...
    Private Sub dxOK_NewStichtagBASIS_click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If IsDate(EAEG_NewStichtag.Stichtag_Comboedit.Text) = True Then
            Try
                ...
                If XtraMessageBox.Show("Soll der EAEG Stichtag: " & rd & " (BASIS VERSION) erstellt werden?", "EAEG Stichtag erstellung (BASIS VERSION)", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
...
#Region "EAEG_EINREICHER_DATEI_ERSTELLUNG_BASIS"
    Private Sub EAEG_EinreicherDatei_Erstellung_BASIS_BarButtonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles EAEG_EinreicherDateiErstellung_BASIS_BarButtonItem.ItemClick
        If XtraMessageBox.Show("Soll die EAEG Datei (BASIS) für den Stichtag: " & Me.EAEG_Stichtag_DateEdit.Text & " erstellt werden?" & vbNewLine & vbNewLine & "Vorhandene Datei mit den selben Namen wird dabei gelöscht!", "EAEG Datei erstellung BASIS (Version 4.1)", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
            Try
                rd = Me.EAEG_Stichtag_DateEdit.Text
                rdsql = rd.ToString("yyyyMMdd")
                SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
                ...
                Try
                    ...
                    If dxSLE_Meldeinhalt_Basis.Text = "Produktion" Then
                        ...
                        If XtraMessageBox.Show("Folgende csv Datei wurde generiert: " & EAEGDATEI & vbNewLine _
                                  & "Die Datei wurde im folgenden Verzeichnis abgelegt:" & vbNewLine _
                           & EAEG_FILE_DIR & vbNewLine & vbNewLine & "Soll das Verzeichnis geöfnet werden?", "EAEG Meldedatei BASIS (PRODUKTION) erfolgreich generiert", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                            System.Diagnostics.Process.Start(EAEG_FILE_DIR)
                        End If
                    ...
                    ElseIf dxSLE_Meldeinhalt_Basis.Text = "Korrektur" Then
                        ...
                        If XtraMessageBox.Show("Folgende csv Datei wurde generiert: " & EAEGDATEI & vbNewLine _
                                  & "Die Datei wurde im folgenden Verzeichnis abgelegt:" & vbNewLine _
                           & EAEG_FILE_DIR & vbNewLine & vbNewLine & "Soll das Verzeichnis geöfnet werden?", "EAEG Meldedatei BASIS (KORREKTUR) erfolgreich generiert", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                            System.Diagnostics.Process.Start(EAEG_FILE_DIR)
                        End If
                    ...
                    ElseIf dxSLE_Meldeinhalt_Basis.Text = "Test" Then
                        ...
                        If XtraMessageBox.Show("Folgende csv Datei wurde generiert: " & EAEGDATEI & vbNewLine _
                                  & "Die Datei wurde im folgenden Verzeichnis abgelegt:" & vbNewLine _
                           & EAEG_FILE_DIR & vbNewLine & vbNewLine & "Soll das Verzeichnis geöfnet werden?", "EAEG Meldedatei BASIS (TEST) erfolgreich generiert", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                            System.Diagnostics.Process.Start(EAEG_FILE_DIR)
                        End If
...
#End Region
    ...
    Private Sub EAEG_Bilanz_Differences_BarbuttonItem_ItemClick(sender As Object, e As ItemClickEventArgs) Handles EAEG_Bilanz_Differences_BarbuttonItem.ItemClick
        Try
            SplashScreenManager.ShowForm(Me, GetType(WaitForm1), True, True, False)
            SplashScreenManager.Default.SetWaitFormCaption("Start loading Data to Excel File for " & Me.EAEG_Stichtag_DateEdit.Text)
    ...
    Private Sub BgwExcelLoad_DoWork(sender As Object, e As DoWorkEventArgs) Handles BgwExcelLoad.DoWork
        Dim rd As Date = Me.EAEG_Stichtag_DateEdit.Text
    ...
    Private Sub BgwExcelLoad_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BgwExcelLoad.RunWorkerCompleted
        ...
        c.Text = "EAEG (EinSiG) - Bilanz Differenzen zum " & Me.EAEG_Stichtag_DateEdit.Text
