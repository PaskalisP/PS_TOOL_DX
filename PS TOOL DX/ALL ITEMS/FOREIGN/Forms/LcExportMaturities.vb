        ...
        If e.Button.ButtonType = DevExpress.XtraEditors.NavigatorButtonType.Remove Then
            Try
                ...
                If SettlementStatus = "PENDING" Then
                    If MessageBox.Show("Should the Maturity with Reference: " & OurReference & " be deleted?", "DELETE MATURITY", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
        ...
        If e.Button.Hint = "Duplicate Row" Then
            Try
                If ExportLCMaturitiesBaseView.RowCount > 0 Then
                    ...
                    If LCreference <> "" Then
                        If MessageBox.Show("Should the Datarow with Our Reference: " & OurReference & " LC Reference:" & LCreference & " be duplicated?", "MATURITY DUPLICATION", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
                            Me.LC_EXPORT_MATURITIESTableAdapter.Update(Me.ForeignDataset.LC_EXPORT_MATURITIES)
                            '+++++++DUPLICATE ROW BASED ON THE ID++++++++++++
                            If cmd.Connection.State = ConnectionState.Closed Then
                                cmd.Connection.Open()
