...
Namespace VbSyntaxHighlightApp
    Public Class VbSyntaxHighlightService
        ...
        Public Sub New(ByVal syntaxEditor As RichEditControl, ByVal document As Document)
            Me.document = document
            Me.document.DefaultCharacterProperties.FontName = "Consolas"
            Me.document.DefaultCharacterProperties.FontSize = 10
...
#Region "#ISyntaxHighlightServiceMembers"
        Public Sub Execute() Implements ISyntaxHighlightService.Execute
            ...
            Dim lang_ID As ParserLanguageID = ParserLanguageID.Basic 'ParserLanguage.FromFileExtension("vb")
